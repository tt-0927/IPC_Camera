...
static NET_TV_CONFIG_CMD_CB_ITEM_S g_astConfigCmdCbTable[] =
{
    ...
    {NET_GET_SD_CARD_STATUS,            NET_TV_CFG_INVALID,                 NULL,   NULL},
    ...
    {NET_GET_AUDIBLE_ALARM_INFO,        NET_SET_AUDIBLE_ALARM_INFO,         NULL,   NULL},
    {NET_GET_ALARM_INPUT_INFO,          NET_SET_ALARM_INPUT_INFO,           NULL,   NULL},
    {NET_GET_ALARM_OUTPUT_INFO,         NET_SET_ALARM_OUTPUT_INFO,          NULL,   NULL},
    {NET_GET_FLASHING_LIGHT_ALARM_INFO, NET_SET_FLASHING_LIGHT_ALARM_INFO,  NULL,   NULL},
    {NET_TV_CFG_INVALID,                NET_TV_TRIGGER_SOUND_LIGHT_ALARM,   NULL,   NULL},
    {NET_GET_PIR_ALARM_INFO,            NET_SET_PIR_ALARM_INFO,             NULL,   NULL},
    ...
    {NET_TV_GET_FACECAPTUREOVERLAYINFO, NET_TV_SET_FACECAPTUREOVERLAYINFO,  NULL,   NULL},
...
{
    return NetTV_RegisterGetCmdCb(NET_GET_SD_CARD_STATUS, pCb);
}
...
{
    return NetTV_RegisterGetCmdCb(NET_GET_AUDIBLE_ALARM_INFO, pCb);
}
...
{
    return NetTV_RegisterSetCmdCb(NET_SET_AUDIBLE_ALARM_INFO, pCb);
}
...
{
    return NetTV_RegisterGetCmdCb(NET_GET_ALARM_INPUT_INFO, pCb);
}
...
{
    return NetTV_RegisterSetCmdCb(NET_SET_ALARM_INPUT_INFO, pCb);
}
...
{
    return NetTV_RegisterGetCmdCb(NET_GET_ALARM_OUTPUT_INFO, pCb);
}
...
{
    return NetTV_RegisterSetCmdCb(NET_SET_ALARM_OUTPUT_INFO, pCb);
}
...
{
    return NetTV_RegisterGetCmdCb(NET_GET_FLASHING_LIGHT_ALARM_INFO, pCb);
}
...
{
    return NetTV_RegisterSetCmdCb(NET_SET_FLASHING_LIGHT_ALARM_INFO, pCb);
}

/**
 * @brief 注册触发声光报警联动事件的回调函数。
 * @author ITC
...
{
    return NetTV_RegisterSetCmdCb(NET_TV_TRIGGER_SOUND_LIGHT_ALARM, pCb);
}
...
{
    return NetTV_RegisterGetCmdCb(NET_GET_PIR_ALARM_INFO, pCb);
}
...
{
    return NetTV_RegisterSetCmdCb(NET_SET_PIR_ALARM_INFO, pCb);
}
...
{
    return NetTV_RegisterGetCmdCb(NET_TV_GET_FACECAPTUREOVERLAYINFO, pCb);
}
...
{
    return NetTV_RegisterSetCmdCb(NET_TV_SET_FACECAPTUREOVERLAYINFO, pCb);
}
