...
typedef enum
{
    NET_CB_TYPE_DEVICE_INFO = 0,         /* 获取设备信息 */
    NET_CB_TYPE_DEVICE_STATUS,
    NET_CB_TYPE_DEVICE_CTRL,
    NET_CB_TYPE_DEVICE_CONFIG,
...
NET_API BOOL NET_STDCALL NET_SERVER_RegisterCb_GetDeviceInfo(NET_COMMON_ECODE_E (*CB)(pNET_DeviceInfo_S pInfo))
{
    ...
    NET_Device_CbItem_S* pItem = &g_cbTable[NET_CB_TYPE_DEVICE_INFO];
    if (pItem->isRegistered)
    {
        return NET_FALSE;
    }

    pItem->enType = NET_CB_TYPE_DEVICE_INFO;
