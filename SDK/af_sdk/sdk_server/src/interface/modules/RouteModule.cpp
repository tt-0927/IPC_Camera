/**
 * @file RouteModule.cpp
 * @author tianl (tianl@kfb.cn)
 * @date 2026-07-28
 * @LastEditors  : qinjt@kfb.cn
 * @LastEditTime : 2026-07-28
 *
 * @brief CRouteModule 模块实现
 * 功能说明：
 * 1. 实现 CRouteModule 模块核心逻辑
 * 2. 校验输入参数并管理模块资源生命周期
 * 3. 向上层提供可复用的 SDK 能力
 */
/*
 ...
 */
static bool IsSafeUploadFileNameChar(char ch)
{
    return (ch >= '0' && ch <= '9') ||
           (ch >= 'A' && ch <= 'Z') ||
           (ch >= 'a' && ch <= 'z') ||
...
void CRouteModule::ClearRoutes()
{
    ...
    NETSDK_LOG_MESSAGE_DEBUG("Route_S registry cleared");
