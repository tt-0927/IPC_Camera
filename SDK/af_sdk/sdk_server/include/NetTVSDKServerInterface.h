...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetDeviceInfo 对应的服务端回调。
 * @param [in] CB 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
NET_API BOOL NET_STDCALL NET_SERVER_RegisterCb_GetDeviceInfo(NET_COMMON_ECODE_E (*CB)(pNET_DeviceInfo_S pInfo));
 ...
 */
NET_API BOOL NET_STDCALL NET_SERVER_RegisterCb_DeviceControl(NET_CB_DeviceControl pCb);
 ...
 * @return TRUE表示成功,其他表示失败
 */
NET_API BOOL NET_STDCALL NET_SERVER_RegisterCb_SetUserPassword(NET_CB_SetUserPassword pCb);
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetNtpCfg 对应的服务端回调。
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetNtpCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetStreamCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetStreamCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetRtspUrl 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetReplayUrl 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_ControlReplay 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetReplayRecordList 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetOsdCapCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetOsdCapCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetImageCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetImageCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetNetworkCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetNetworkCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetConfigWifiSta 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_ConnectWifiSta 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_DisconnectWifiSta 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_Get4GInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_Set4GInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetHotspotInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetHotspotConn 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetSecurityServicesInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetSecurityServicesInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetSshCountdown 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_FindLog 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_ExportLog 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetLogServer 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetLogServer 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_TestLogServer 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_ControlRecordInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetRecordStatus 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetRecordSchedule 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetRecordSchedule 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetRecordAdvancedParam 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetRecordAdvancedParam 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_FindRecordFileInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_DownloadRecordFile 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetPrivacyMaskCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetPrivacyMaskCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetTamperAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetTamperAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetMotionAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetMotionAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetCrossLineAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetCrossLineAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetIntrusionAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetIntrusionAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetLoiteringAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetLoiteringAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetAudioAnomalyAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetAudioAnomalyAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetPreviewInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetPreviewInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetChannelInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetChannelList 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetCrowGatheringAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetCrowGatheringAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetParkingAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetParkingAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetUnattendedObjectAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetUnattendedObjectAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetObjectRemovalAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetObjectRemovalAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetSceneChangeAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetSceneChangeAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetGarbageExposureCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetGarbageExposureCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetGarbageOverflowCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetGarbageOverflowCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetTalkbackState 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetTalkbackToStream 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetTalkbackFromStream 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetReplayTalkback 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetUpgradeStatus 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetUpgrade 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetUpgradeVersion 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetCapturePlanInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetCapturePlanInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetCaptureParamInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetCaptureParamInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetExposureInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetExposureInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetDayNightInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetDayNightInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetBackLightInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetBackLightInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetDenoiseInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetDenoiseInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetWhiteBalanceInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetWhiteBalanceInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetAudioCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetAudioCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetEnterRegionAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetEnterRegionAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetLeaveRegionAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetLeaveRegionAlarm 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetFaceCaptureInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetFaceCaptureInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetFaceCompareInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_AddTargetLib 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_DelTargetLib 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetTargetLib 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetTargetLib 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_AddFaceInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_DelFaceInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetFaceInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetFaceInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetPeopleFlowStatisticsCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetPeopleFlowStatisticsCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_ResetPeopleFlowStatistics 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetPeopleDensityDetectionCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetPeopleDensityDetectionCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetManholeCoverAbnormalCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetManholeCoverAbnormalCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetSleepOnDutyCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetSleepOnDutyCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetElectricVehicleInElevatorCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetElectricVehicleInElevatorCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetPersonFallDownCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetPersonFallDownCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetConstructionOccupyRoadCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetConstructionOccupyRoadCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetCongestionCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetCongestionCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetLicensePlateRecognitionCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetLicensePlateRecognitionCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetHighAltitudeSeatbeltCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetHighAltitudeSeatbeltCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetSafetyHelmetCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetSafetyHelmetCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetPersonFallCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetPersonFallCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetPhoneUsageCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetPhoneUsageCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetSmokingCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetSmokingCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetOpenFlameCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetOpenFlameCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetBareSoilCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetBareSoilCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetHoleProtectionBarCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetHoleProtectionBarCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetReflectiveClothingCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetReflectiveClothingCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetPetRecognitionInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetClimbFenceInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetClimbFenceInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetDimissionInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetDimissionInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetIllegalLaneInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetIllegalLaneInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetRetrogradeInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetRetrogradeInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetNonmotorVehicleIntrusionInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetNonmotorVehicleIntrusionInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetOccupationEmergencyInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetOccupationEmergencyInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetPedestrianIntrusionInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetPedestrianIntrusionInfo 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetSmokeFireCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetSmokeFireCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_GetRoadPondingCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_SetRoadPondingCfg 对应的服务端回调。
 * @param [in] pCb 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
 ...
 */
typedef void(NET_STDCALL *NET_CB_GetDiscoveryDeviceInfo)(
    NET_OUT NET_DiscoveryDeviceInfo_S* pDeviceInfo);
...
typedef void (NET_STDCALL *NET_SERVER_VoiceComPlayCallBack)(const char* data, unsigned int size);
/**
 * @author tianl (tianl@kfb.cn)
 ...
 */
typedef INT32 (NET_STDCALL *NET_SERVER_VoiceComCaptureCallBack)(
    NET_IN const NET_VoiceComAudioParam_S* pstAudioParam,
    NET_OUT CHAR* pBuffer,
    NET_IN UINT32 dwBufferSize,
 ...
 * @return NET_TRUE 成功，NET_FALSE 表示尚未建立会话或参数未协商
 */
NET_API BOOL NET_STDCALL
 ...
 */
typedef NET_COMMON_ECODE_E (NET_STDCALL *NET_SERVER_RecordFrameStartCallBack)(
    NET_IN pNET_RecordFrameStreamCond_S pstCond,
    NET_INOUT pNET_RecordFrameStreamInfo_S pstInfo,
    NET_IN LPVOID lpUserData);
 ...
 */
typedef INT32 (NET_STDCALL *NET_SERVER_RecordFrameReadCallBack)(
    NET_IN const CHAR* szStreamId,
    NET_OUT pNET_RecordFrameInfo_S pstFrameInfo,
    NET_OUT CHAR* pBuffer,
    NET_IN UINT32 dwBufferSize,
    NET_IN LPVOID lpUserData);

/** @brief 录像帧流停止回调: 客户端停止或流结束时调用 */
typedef NET_COMMON_ECODE_E (NET_STDCALL *NET_SERVER_RecordFrameStopCallBack)(
    NET_IN const CHAR* szStreamId,
    NET_IN LPVOID lpUserData);

/**
 * @author tianl (tianl@kfb.cn)
 * @brief 启动 NET_SERVER_StartRecordFrameServer 对应的服务能力。
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 停止 NET_SERVER_StopRecordFrameServer 对应的服务能力。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
NET_API BOOL NET_STDCALL
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_RecordFrameStart 对应的服务端回调。
 * @param [in] cb 服务端回调函数指针。
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_RecordFrameRead 对应的服务端回调。
 * @param [in] cb 服务端回调函数指针。
 * @param [in] lpUserData 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
...
/**
 * @author tianl (tianl@kfb.cn)
 * @brief 注册 NET_SERVER_RegisterCb_RecordFrameStop 对应的服务端回调。
 * @param [in] cb 服务端回调函数指针。
 * @param [in] lpUserData 服务端回调函数指针。
 * @return NET_TRUE 表示成功；NET_FALSE 表示失败。
 */
