...
static const char* GetStatisticsTypeName(UINT32 type) {
    switch (type) {
        case NET_STATISTICS_TYPE_PEOPLE_FLOW: return "PeopleFlow";
        case NET_STATISTICS_TYPE_PEOPLE_DENSITY: return "PeopleDensity";
        default: return "Unknown";
    }
}

static const char* GetCaptureTypeName(UINT32 type) {
    switch (type) {
        case NET_CAPTURE_TYPE_PEOPLE: return "People";
        case NET_CAPTURE_TYPE_FACE: return "Face";
        case NET_CAPTURE_TYPE_VEHICLE: return "Vehicle";
        case NET_CAPTURE_TYPE_NON_MOTOR: return "NonMotor";
        default: return "Unknown";
    }
}

static const char* GetAlarmBaseName(INT64 command) {
    INT64 base = command & 0xFF00;
    switch (base) {
        case NET_ALARM_BASE_BASIC: return "BASIC";
        case NET_ALARM_BASE_RULE: return "RULE";
        case NET_ALARM_BASE_AI: return "AI";
        case NET_ALARM_BASE_TRAFFIC: return "TRAFFIC";
        case NET_ALARM_BASE_EXCEPTION: return "EXCEPTION";
        case NET_ALARM_BASE_STATISTICS: return "STATISTICS";
        case NET_ALARM_BASE_CAPTURE: return "CAPTURE";
...
{
    switch (alarmType) {
        case NET_ALARM_MOTION_DETECT: return "MOTION_DETECT";
        case NET_ALARM_OCCLUSION: return "OCCLUSION";
        case NET_ALARM_LINE_CROSSING: return "LINE_CROSSING";
        case NET_ALARM_INTRUSION: return "INTRUSION";
        case NET_ALARM_ENTER_REGION: return "ENTER_REGION";
        case NET_ALARM_LEAVE_REGION: return "LEAVE_REGION";
        case NET_ALARM_FACE_DETECT: return "FACE_DETECT";
        case NET_ALARM_FACE_CAPTURE: return "FACE_CAPTURE";
        case NET_ALARM_FACE_COMPARE: return "FACE_COMPARE";
        case NET_ALARM_LOITERING: return "LOITERING";
        case NET_ALARM_PARKING_DETECT: return "PARKING_DETECT";
        case NET_ALARM_UNATTENDED_OBJECT: return "UNATTENDED_OBJECT";
        case NET_ALARM_OBJECT_REMOVAL: return "OBJECT_REMOVAL";
        case NET_ALARM_CROWD_GATHERING: return "CROWD_GATHERING";
        case NET_ALARM_SLEEP_ON_DUTY: return "SLEEP_ON_DUTY";
        case NET_ALARM_HELMET_MISSING: return "HELMET_MISSING";
        case NET_ALARM_PERSON_FALL: return "PERSON_FALL";
        case NET_ALARM_PHONE_USAGE: return "PHONE_USAGE";
        case NET_ALARM_SMOKING: return "SMOKING";
        case NET_ALARM_SMOKE_FIRE: return "SMOKE_FIRE";
        case NET_ALARM_NO_REFLECTIVE_VEST: return "NO_REFLECTIVE_VEST";
        case NET_ALARM_PLATE_RECOGNITION: return "PLATE_RECOGNITION";
        case NET_ALARM_TRAFFIC_CONGESTION: return "TRAFFIC_CONGESTION";
        case NET_ALARM_VIDEO_LOSS: return "VIDEO_LOSS";
        case NET_ALARM_PEOPLE_FLOW_STATISTICS: return "PEOPLE_FLOW_STATISTICS";
        case NET_ALARM_PEOPLE_DENSITY_STATISTICS: return "PEOPLE_DENSITY_STATISTICS";
        case NET_ALARM_CAPTURE_PEOPLE: return "CAPTURE_PEOPLE";
        case NET_ALARM_CAPTURE_FACE: return "CAPTURE_FACE";
        case NET_ALARM_CAPTURE_VEHICLE: return "CAPTURE_VEHICLE";
        case NET_ALARM_CAPTURE_NON_MOTOR: return "CAPTURE_NON_MOTOR";
...
static const char* GetAlarmCommandName(INT64 command) {
    switch (command) {
        case NET_ALARM_BASE_BASIC: return "ALARM_BASE_BASIC";
        case NET_ALARM_BASE_RULE: return "ALARM_BASE_RULE";
        case NET_ALARM_BASE_AI: return "ALARM_BASE_AI";
        case NET_ALARM_BASE_TRAFFIC: return "ALARM_BASE_TRAFFIC";
        case NET_ALARM_BASE_EXCEPTION: return "ALARM_BASE_EXCEPTION";
        case NET_ALARM_BASE_STATISTICS: return "ALARM_BASE_STATISTICS";
        case NET_ALARM_FACE_DETECT: return "FACE_DETECT";
        case NET_ALARM_FACE_CAPTURE: return "FACE_CAPTURE";
        case NET_ALARM_FACE_COMPARE: return "FACE_COMPARE";
        case NET_ALARM_LOITERING: return "LOITERING";
        ...
        case NET_ALARM_PEOPLE_FLOW_STATISTICS: return "PEOPLE_FLOW_STATISTICS";
        case NET_ALARM_PEOPLE_DENSITY_STATISTICS: return "PEOPLE_DENSITY_STATISTICS";
        case NET_ALARM_BASE_CAPTURE: return "ALARM_BASE_CAPTURE";
        case NET_ALARM_CAPTURE_PEOPLE: return "CAPTURE_PEOPLE";
        case NET_ALARM_CAPTURE_FACE: return "CAPTURE_FACE";
        case NET_ALARM_CAPTURE_VEHICLE: return "CAPTURE_VEHICLE";
        case NET_ALARM_CAPTURE_NON_MOTOR: return "CAPTURE_NON_MOTOR";
...
void STDCALL AlarmCallBack(OUT INT64 lCommand,
    ...
    INT64 alarmBase = lCommand & 0xFF00;


    if (pAlarmInfo && dwBufLen && *dwBufLen > 0) {
        if (alarmBase == NET_ALARM_BASE_BASIC &&
            *dwBufLen >= (INT32)sizeof(NET_AlarmBasicInfo_S)) {
        ...
        } else if (lCommand == NET_ALARM_FACE_COMPARE &&
            ...
            if (lCommand == NET_ALARM_FACE_DETECT ||
                lCommand == NET_ALARM_FACE_CAPTURE ||
                lCommand == NET_ALARM_FACE_COMPARE) {
                const bool isFaceCompare = lCommand == NET_ALARM_FACE_COMPARE;
            ...
            printf("  [EXCEPTION/异常告警] AlarmType: 0x%x (%s), 通道 / Channel: %u, 硬盘号 / DiskNo: %u, 状态 / Status: %u\n",
                   ...
                   *dwBufLen >= (INT32)sizeof(NET_AlarmCaptureInfo_S)) {
            auto* info = (NET_AlarmCaptureInfo_S*)pAlarmInfo;
            printf("  [CAPTURE/抓拍] AlarmType: 0x%x (%s), 通道 / Channel: %u, 抓拍类型 / CaptureType: %u (%s), 时间戳 / TimestampMs: %lld\n",
                   info->uAlarmType, GetAlarmTypeName(info->uAlarmType), info->uChannel,
                   info->uCaptureType, GetCaptureTypeName(info->uCaptureType), (long long)info->llTimestampMs);
            printf("  [CAPTURE/抓拍] 全景图分辨率 / PanoramaSize: %ux%u, 全景图长度 / PanoramaLen: %u, 裁剪数量 / CropCount: %u\n",
                   info->uPanoramaWidth, info->uPanoramaHeight,
                   info->stPanoramaImg.uDataLen, info->uCropCount);

            /* 保存全景图 */
            if (info->stPanoramaImg.pData && info->stPanoramaImg.uDataLen > 0) {
                printf("  [CAPTURE/抓拍][全景图/Panorama] [OK] 有图片数据 / Image available, 长度 / Length: %u bytes (异步保存 / saving async)\n",
                       info->stPanoramaImg.uDataLen);
                const char* eventName = info->uAlarmType == NET_ALARM_CAPTURE_PEOPLE ? "capture_people" :
                                        info->uAlarmType == NET_ALARM_CAPTURE_FACE ? "capture_face" :
                                        info->uAlarmType == NET_ALARM_CAPTURE_VEHICLE ? "capture_vehicle" : "capture_non_motor";
                SubmitImageSave(pAlarmer ? pAlarmer->strDeviceIP : nullptr,
                               eventName, "panorama",
                               info->stPanoramaImg.pData, info->stPanoramaImg.uDataLen);
            } else {
                printf("  [CAPTURE/抓拍][全景图/Panorama] [NO] 无图片数据 / No image\n");
            }

            /* 遍历裁剪小图 */
            UINT32 cropCount = std::min<UINT32>(info->uCropCount, NET_CAPTURE_CROP_MAX_NUM);
            for (UINT32 i = 0; i < cropCount; ++i) {
                const auto& crop = info->stCropImages[i];
                printf("  [CAPTURE/抓拍][裁剪%u] 坐标 / Rect: [%u,%u,%u,%u], 目标类型 / TargetType: %u, 置信度 / Confidence: %.3f, TrackID: %d, 图片长度 / ImgLen: %u\n",
                       i, crop.uCropX, crop.uCropY, crop.uCropWidth, crop.uCropHeight,
                       crop.uTargetType, crop.fConfidence, crop.nTrackID, crop.stImage.uDataLen);

                if (crop.stImage.pData && crop.stImage.uDataLen > 0) {
                    printf("  [CAPTURE/抓拍][裁剪%u] [OK] 有图片数据 / Image available (异步保存 / saving async)\n", i);
                    const char* eventName = info->uAlarmType == NET_ALARM_CAPTURE_PEOPLE ? "capture_people" :
                                            info->uAlarmType == NET_ALARM_CAPTURE_FACE ? "capture_face" :
                                            info->uAlarmType == NET_ALARM_CAPTURE_VEHICLE ? "capture_vehicle" : "capture_non_motor";
                    const std::string kind = "crop_" + std::to_string(i);
                    SubmitImageSave(pAlarmer ? pAlarmer->strDeviceIP : nullptr,
                                   eventName, kind.c_str(),
                                   crop.stImage.pData, crop.stImage.uDataLen);
                } else {
                    printf("  [CAPTURE/抓拍][裁剪%u] [NO] 无图片数据 / No image\n", i);
                }
            }
            ...
            for (UINT32 i = 0; i < targetCount; ++i) {
                ...
                if (target.uImgLen > 0) {
                    const UINT32 imgLen = std::min<UINT32>(target.uImgLen, NET_PIC_DATA_MAX_LEN);
                    printf("  [STATISTICS/统计告警][特写图片/Close-up][目标%u] [OK] 有图片数据 / Image available, 长度 / Length: %u bytes (异步保存 / saving async)\n", i, imgLen);
                    ...
                    printf("  [STATISTICS/统计告警][特写图片/Close-up][目标%u] [NO] 无图片数据 / No image\n", i);
                }
            }
            ...
            if (info->uPanoramaImgLen > 0) {
                const UINT32 imgLen = std::min<UINT32>(info->uPanoramaImgLen, NET_PIC_DATA_MAX_LEN);
                printf("[OK] 有图片数据 / Image available, 长度 / Length: %u bytes (异步保存 / saving async)\n", imgLen);
                const char* eventName = info->uStatisticsType == NET_STATISTICS_TYPE_PEOPLE_DENSITY ? "density" : "flow";
                SubmitImageSave(pAlarmer ? pAlarmer->strDeviceIP : nullptr,
                               eventName, "panorama",
                               info->byPanoramaImg, imgLen);
            } else {
                printf("[NO] 无图片数据 / No image\n");
            }
        } else {
...
int main() {
    ...
    mkdir(logDir, 0755);
#endif
    if (!NET_clientSetLogToFile(0, (char*)logDir, 5 * 1024 * 1024, 10)) {
        printf("NET_clientSetLogToFile failed!\n");
    } else {
        printf("NET_clientSetLogToFile success, log directory: %s\n", logDir);
    }
    ...
    LPVOID lpUserID = NET_clientLogin(&struLoginInfo, &struDeviceInfo);

    if (lpUserID == NULL) { 
        printf("NET_clientLogin failed!\n");
        NET_clientCleanup();
        return -1;
    }
    ...
    // Set Alarm Callback
    if (!NET_clientSetAlarmCallBack(lpUserID, AlarmCallBack, NULL)) {
        printf("NET_clientSetAlarmCallBack failed!\n");
        NET_clientLogout(lpUserID);
        NET_clientCleanup();
        return -1;
    }
    printf("SetAlarmCallBack success.\n");

    if (!NET_clientSetChannelStatusCallBack(lpUserID, OnChannelStatus, NULL)) {
        printf("NET_clientSetChannelStatusCallBack failed!\n");
        NET_clientLogout(lpUserID);
        NET_clientCleanup();
        return -1;
    }
    ...
    // Start Listening
    if (!NET_clientStartListen(lpUserID)) {
        printf("NET_clientStartListen failed!\n");
        NET_clientLogout(lpUserID);
        NET_clientCleanup();
        return -1;
    }
