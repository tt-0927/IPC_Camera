...
public:
    ...
    void SetCallbackV2(NET_TV_AlarmCallBackV2 cb, void* userData)
    {
        alarmCbV2_ = cb;
        alarmUserDataV2_ = userData;
    }
...
private:
    ...
    NET_TV_AlarmCallBackV2 alarmCbV2_ = nullptr;
    void* alarmUserData_ = nullptr;
    void* alarmUserDataV2_ = nullptr;
