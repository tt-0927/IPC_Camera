 ...
 * @param [IN] pass 密码
 */
CAlarmListener::CAlarmListener(const std::string& host, int port, const std::string& user, const std::string& pass)
 ...
 */
bool CAlarmListener::StartListen(void* userHandle, const std::string& sessionId)
{
    // 确保旧线程完全停止再启动
    Stop();
