                                      ...
                                      INT32 *pdwBytesReturned)
{
    switch (dwCommand)
    {
        ...
        case NET_GET_STREAMCFG:          return GetDevConfig_Impl<NET_VideoEncodeOption_S, true>(lpUserID, dwChannelID, dwCommand, lpOutBuffer, dwOutBufferSize, pdwBytesReturned);
