...
class CCommandExecutor : public CSingleton<CCommandExecutor>
{
    CCommandExecutor()
	{
...
public:
    ...
    friend class CSingleton<CCommandExecutor>;
    ...
    bool ExecuteGet(LPUSER_HANDLE pHandle, const std::string& url, void* pOut, int* pOutLen)
	{
        ...
        auto session = CSessionManager::instance()->GetSession(pHandle);
        if (!session)
		{
