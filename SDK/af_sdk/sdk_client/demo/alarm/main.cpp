...
static const char* GetAlarmTypeName(UINT32 alarmType) 
{
    switch (alarmType) {
        ...
        case NET_TV_ALARM_PERSON_TRIP: return "PERSON_TRIP";
        case NET_TV_ALARM_ELECTRIC_VEHICLE_IN_ELEVATOR: return "ELECTRIC_VEHICLE_IN_ELEVATOR";
        case NET_TV_ALARM_GARBAGE_EXPOSURE: return "GARBAGE_EXPOSURE";
        case NET_TV_ALARM_GARBAGE_OVERFLOW: return "GARBAGE_OVERFLOW";
        case NET_TV_ALARM_MANHOLE_COVER_ABNORMAL: return "MANHOLE_COVER_ABNORMAL";
        case NET_TV_ALARM_FENCE_CLIMBING: return "FENCE_CLIMBING";
        case NET_TV_ALARM_BARE_SOIL: return "BARE_SOIL";
        case NET_TV_ALARM_HOLE_PROTECTION_BAR: return "HOLE_PROTECTION_BAR";
        case NET_TV_ALARM_PEDESTRIAN_INTRUSION: return "PEDESTRIAN_INTRUSION";
        case NET_TV_ALARM_HIGH_ALTITUDE_SEATBELT: return "HIGH_ALTITUDE_SEATBELT";
        case NET_TV_ALARM_CONSTRUCTION_OCCUPY_ROAD: return "CONSTRUCTION_OCCUPY_ROAD";
        case NET_TV_ALARM_EMERGENCY_LANE_OCCUPANCY: return "EMERGENCY_LANE_OCCUPANCY";
        case NET_TV_ALARM_REVERSE_DIRECTION: return "REVERSE_DIRECTION";
        case NET_TV_ALARM_NON_MOTOR_VEHICLE_INTRUSION: return "NON_MOTOR_VEHICLE_INTRUSION";
        case NET_TV_ALARM_ROAD_PONDING: return "ROAD_PONDING";
        case NET_TV_ALARM_CONGESTION: return "CONGESTION";
        case NET_TV_ALARM_ILLEGAL_LANE_CHANGE: return "ILLEGAL_LANE_CHANGE";
        case NET_TV_ALARM_SCENE_CHANGE: return "SCENE_CHANGE";
        case NET_TV_ALARM_OPEN_FLAME: return "OPEN_FLAME";
        case NET_TV_ALARM_AUDIO_SUDDEN_RISE: return "AUDIO_SUDDEN_RISE";
        case NET_TV_ALARM_AUDIO_SUDDEN_DROP: return "AUDIO_SUDDEN_DROP";
...
static const char* GetAlarmCommandName(INT64 command) {
    switch (command) {
        ...
        case NET_TV_ALARM_PEOPLE_FLOW_STATISTICS: return "PEOPLE_FLOW_STATISTICS";
        case NET_TV_ALARM_PEOPLE_DENSITY_STATISTICS: return "PEOPLE_DENSITY_STATISTICS";
        case NET_PUSH_FACE_CAPTURE_INFO: return "PUSH_FACE_CAPTURE_INFO";
        case NET_PUSH_PERSON_CAPTURE_INFO: return "PUSH_PERSON_CAPTURE_INFO";
        case NET_PUSH_MOTORVEHICLE_CAPTURE_INFO: return "PUSH_MOTORVEHICLE_CAPTURE_INFO";
        case NET_PUSH_NONMOTORVEHICLE_CAPTURE_INFO: return "PUSH_NONMOTORVEHICLE_CAPTURE_INFO";
        default: return "UNKNOWN";
    }
}
...
void STDCALL AlarmCallBack(OUT INT64 lCommand,
    ...
    if (pAlarmInfo && dwBufLen && *dwBufLen > 0) {
        if (lCommand == NET_PUSH_FACE_CAPTURE_INFO &&
            *dwBufLen >= (INT32)sizeof(NET_FaceCapturePushInfo_S)) {
            const auto* pCaptureInfo = (const NET_FaceCapturePushInfo_S*)pAlarmInfo;
            printf("  [FACE_CAPTURE] Male=%d, Age=%d, FaceImgLen=%u, PanoramaImgLen=%u, Timestamp=%s\n",
                   pCaptureInfo->bMale,
                   pCaptureInfo->nAgeLabel,
                   pCaptureInfo->uFaceImgLen,
                   pCaptureInfo->uPanoramaImgLen,
                   pCaptureInfo->strTimestamp);
        } else if (lCommand == NET_PUSH_PERSON_CAPTURE_INFO &&
                   *dwBufLen >= (INT32)sizeof(NET_PersonCapturePushInfo_S)) {
            const auto* pCaptureInfo = (const NET_PersonCapturePushInfo_S*)pAlarmInfo;
            printf("  [PERSON_CAPTURE] Male=%d, Age=%d, HasBag=%d, PersonImgLen=%u, PanoramaImgLen=%u, Timestamp=%s\n",
                   pCaptureInfo->bMale,
                   pCaptureInfo->nAgeLabel,
                   pCaptureInfo->bBag,
                   pCaptureInfo->uPersonImgLen,
                   pCaptureInfo->uPanoramaImgLen,
                   pCaptureInfo->strTimestamp);
        } else if (lCommand == NET_PUSH_MOTORVEHICLE_CAPTURE_INFO &&
                   *dwBufLen >= (INT32)sizeof(NET_MotorvehicleCapturePushInfo_S)) {
            const auto* pCaptureInfo = (const NET_MotorvehicleCapturePushInfo_S*)pAlarmInfo;
            printf("  [MOTORVEHICLE_CAPTURE] Brand=%s, Plate=%s, Type=%d, Color=%d, TargetImgLen=%u, PanoramaImgLen=%u, Timestamp=%s\n",
                   pCaptureInfo->strVehicleBrand,
                   pCaptureInfo->strLicensePlateNumber,
                   pCaptureInfo->nVehicleType,
                   pCaptureInfo->nVehicleColor,
                   pCaptureInfo->uTargetImgLen,
                   pCaptureInfo->uPanoramaImgLen,
                   pCaptureInfo->strTimestamp);
        } else if (lCommand == NET_PUSH_NONMOTORVEHICLE_CAPTURE_INFO &&
                   *dwBufLen >= (INT32)sizeof(NET_NonMotorvehicleCapturePushInfo_S)) {
            const auto* pCaptureInfo = (const NET_NonMotorvehicleCapturePushInfo_S*)pAlarmInfo;
            printf("  [NONMOTORVEHICLE_CAPTURE] Type=%d, Color=%d, TargetImgLen=%u, PanoramaImgLen=%u, Timestamp=%s\n",
                   pCaptureInfo->nVehicleType,
                   pCaptureInfo->nVehicleColor,
                   pCaptureInfo->uTargetImgLen,
                   pCaptureInfo->uPanoramaImgLen,
