 ...
 *
 * 演示内容：
 * 1. 使用 NET_GetDevConfig 获取设备基本信息 / 网络配置
 * 2. 使用 NET_SetDevConfig 修改设备基本信息 / 网络配置
 *
 * 说明：
...
/* NVR control 内部平台点播命令码，客户端通过 NET_ControlReplay 触发服务端转发 */
#define DEMO_AC_PLATFORM_PLAY 3213
/* demo 本地命令码：暂停也走 NET_ControlReplay，不是新增 SDK 接口 */
...
static void PrintMenu()
{
    ...
    printf("76 - 获取通道信息             (NET_GET_CHANNEL_INFO)\n");
    printf("77 - 获取通道列表             (NET_GET_CHANNEL_LIST)\n");
    ...
    printf("169 - VoiceCom发送音频文件 (NET_StartVoiceCom/SendData)\n");
...
static void DoGetDeviceCfg()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取设备基本信息...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID,
        1, /* ChannelID */
        NET_GET_DEVICECFG,
        &stInfo,
...
static void DoSetDeviceCfg()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置设备基本信息(示例值)...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
        g_lpUserID,
        1,
        NET_SET_DEVICECFG,
        &stInfo,
...
static void DoGetNetworkCfg()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取网络配置...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
        NET_GET_NETWORKCFG,
...
static void DoSetNetworkCfg()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置网络配置(示例值)...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
        g_lpUserID,
        1,
...
static void DoGetSystemNtpCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取系统校时配置...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
        NET_GET_NTPCFG,
...
static void DoSetSystemNtpCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置系统校时配置(客户端当前时间示例)...\n");
    BOOL bRet = NET_SetDevConfig(
        g_lpUserID,
        1,
        NET_SET_NTPCFG,
...
static void DoGetAudioCfg()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取音频配置...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
        NET_GET_AUDIOCFG,
...
static void DoSetAudioCfg()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置音频配置...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
        g_lpUserID,
        1,
...
static void DoGetVoiceComAudioCfg()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取对讲音频参数...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
...
static void DoSetVoiceComAudioCfg()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置对讲音频参数...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
        g_lpUserID,
        1,
...
static void DoGetStreamCfg()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取视频码流配置...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
        NET_GET_STREAMCFG,
...
static void DoSetStreamCfg()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置视频码流配置...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
        g_lpUserID,
        1,
...
static void DoSetConfigWifiSta()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置WIFI STA基础配置...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
        g_lpUserID,
        1,
...
static void DoConnectWifiSta()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 连接WIFI STA...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
        g_lpUserID,
        1,
...
static void DoDisconnectWifiSta()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 断开WIFI STA...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
        g_lpUserID,
        1,
...
static void DoGet4GInfo()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取4G配置...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
        NET_GET_4G_INFO,
...
static void DoSet4GInfo()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置4G配置...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
        g_lpUserID,
        1,
...
static void DoSetHotspotInfo()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置热点配置...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
        g_lpUserID,
        1,
...
static void DoGetHotspotConn()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取热点连接设备...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
...
static void DoGetSecurityServicesInfo()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取安全服务配置...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
...
static void DoSetSecurityServicesInfo()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置安全服务配置...\n");
    BOOL bRet = NET_SetDevConfig(
        g_lpUserID,
        1,
...
static void DoGetSshCountdown()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取SSH倒计时...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
...
static void DoQueryLog(INT32 dwCommand, const char* pszName)
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig %s...\n", pszName);
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
        dwCommand,
...
static void DoGetLogServer()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取日志服务器配置...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
        NET_GET_LOG_SERVER,
...
static void DoSetLogServer()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置日志服务器配置...\n");
    BOOL bRet = NET_SetDevConfig(
        g_lpUserID,
        1,
        NET_SET_LOG_SERVER,
...
static void DoControlRecordInfo(INT32 nRecordStatus)
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_SetDevConfig 控制手动录像...\n");
...
static void DoGetRecordStatus()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取录像状态...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
...
static void DoGetRecordSchedule()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取录像计划...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
...
static void DoSetRecordSchedule()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置录像计划...\n");
    BOOL bRet = NET_SetDevConfig(
        g_lpUserID,
        1,
...
static void DoGetRecordAdvancedParam()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取录像高级参数...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
...
static void DoSetRecordAdvancedParam()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置录像高级参数...\n");
    BOOL bRet = NET_SetDevConfig(
        g_lpUserID,
        1,
...
static void DoFindRecordFileInfo()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 查找录像文件...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
...
static void DoDownloadRecordFile()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_SetDevConfig 下载录像文件...\n");
...
static void DoTestLogServer()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_SetDevConfig 测试日志服务器配置...\n");
    BOOL bRet = NET_SetDevConfig(
        g_lpUserID,
        1,
        NET_TEST_LOG_SERVER,
...
static void DoGetOSDCapCfg()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取OSD能力集配置...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
        NET_GET_OSDCAPCFG,
...
static void DoSetOSDCapCfg()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置OSD能力集配置(示例值)...\n");
    PrintOSDCfg(&stCfg);
...
static void DoGetRtspUrl()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取RTSP流地址...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
        NET_GET_RTSPURLCFG,
...
static void DoGetMotionAlarm()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取移动侦测配置...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
        NET_GET_MOTIONALARM,
...
static void DoSetMotionAlarm()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置移动侦测配置...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetTamperAlarm()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取遮挡报警配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetTamperAlarm()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置遮挡报警配置...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetPrivacyMaskCfg()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取隐私遮盖配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetPrivacyMaskCfg()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置隐私遮盖配置...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetCrossLineAlarm()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取越界检测配置...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
...
static void DoSetCrossLineAlarm()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置越界检测配置...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetIntrusionAlarm()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取入侵检测配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetIntrusionAlarm()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置入侵检测配置...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetLoiteringAlarm()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取徘徊侦测配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetLoiteringAlarm()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置徘徊侦测配置...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
        g_lpUserID, 1, NET_SET_LOITERINGALARM,
        &stInfo, (INT32)sizeof(stInfo), &dwBytesReturnedSet
...
static void DoGetSceneChangeAlarm()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取场景变更侦测配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetSceneChangeAlarm()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置场景变更侦测配置...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetCrowdGatheringAlarm()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取人员聚集配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetCrowdGatheringAlarm()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置人员聚集配置...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetGarbageExposureCfg()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取垃圾暴露配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetGarbageExposureCfg()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置垃圾暴露配置...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetGarbageOverflowCfg()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取垃圾满溢配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetGarbageOverflowCfg()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置垃圾满溢配置...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetPeopleFlowStatisticsCfg()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取人流统计配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetPeopleFlowStatisticsCfg()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置人流统计配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoResetPeopleFlowStatistics()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 清零人流统计...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetPeopleDensityDetectionCfg()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取人员密度检测配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetPeopleDensityDetectionCfg()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置人员密度检测配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetManholeCoverAbnormalCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取井盖异常检测配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetManholeCoverAbnormalCfg()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置井盖异常检测配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetSleepOnDutyCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取睡岗识别配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetSleepOnDutyCfg()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置睡岗识别配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetElectricVehicleInElevatorCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取电瓶车进电梯识别配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetElectricVehicleInElevatorCfg()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置电瓶车进电梯识别配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetPersonFallDownCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取人员倒地识别配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetPersonFallDownCfg()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置人员倒地识别配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetConstructionOccupyRoadCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取施工占道识别配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetConstructionOccupyRoadCfg()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置施工占道识别配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetCongestionCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取拥堵识别配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetCongestionCfg()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置拥堵识别配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetLicensePlateRecognitionCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取车牌识别配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetLicensePlateRecognitionCfg()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置车牌识别配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetHighAltitudeSeatbeltCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取高空安全带识别配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetHighAltitudeSeatbeltCfg()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置高空安全带识别配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetSafetyHelmetCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取安全帽识别配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetSafetyHelmetCfg()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置安全帽识别配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetPersonFallCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取摔倒识别配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetPersonFallCfg()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置摔倒识别配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetPhoneUsageCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取玩手机识别配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetPhoneUsageCfg()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置玩手机识别配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetSmokingCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取抽烟识别配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetSmokingCfg()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置抽烟识别配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetOpenFlameCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取明火识别配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetOpenFlameCfg()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置明火识别配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetBareSoilCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取黄土裸露识别配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetBareSoilCfg()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置黄土裸露识别配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetHoleProtectionBarCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取洞口防护栏识别配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetHoleProtectionBarCfg()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置洞口防护栏识别配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetReflectiveClothingCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取反光衣识别配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetReflectiveClothingCfg()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置反光衣识别配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetPetRecognitionInfo()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取宠物识别配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetPetRecognitionInfo()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置宠物识别配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetClimbFenceInfo()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取翻越围栏配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetClimbFenceInfo()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置翻越围栏配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetDimissionInfo()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取离岗配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetDimissionInfo()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置离岗配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetIllegalLaneInfo()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取违规变道配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetIllegalLaneInfo()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置违规变道配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetRetrogradeInfo()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取逆行配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetRetrogradeInfo()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置逆行配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetNonmotorVehicleIntrusionInfo()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取非机动车闯入配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetNonmotorVehicleIntrusionInfo()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置非机动车闯入配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetOccupationEmergencyInfo()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取应急车道占用识别配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetOccupationEmergencyInfo()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置应急车道占用识别配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetPedestrianIntrusionInfo()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取行人闯入配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetPedestrianIntrusionInfo()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置行人闯入配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetSmokeFireCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取烟火识别配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetSmokeFireCfg()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置烟火识别配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetRoadPondingCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取道路积水检测配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetRoadPondingCfg()
{
    ...
    INT32 dwBytesReturnedSet = 0;
    printf("[Client] 调用 NET_SetDevConfig 设置道路积水检测配置...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetParkingAlarm()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取停车侦测配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetParkingAlarm()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置停车侦测配置...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetUnattendedObjectAlarm()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取物品遗留侦测配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetUnattendedObjectAlarm()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置物品遗留侦测配置...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetObjectRemovalAlarm()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取物品拿去侦测配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoGetAudioAnomalyAlarm()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取音频异常侦测配置...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetAudioAnomalyAlarm()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置音频异常侦测配置...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
...
static void PrintChannelInfo(const NET_ChannelInfo_S* pInfo)
{
    if (!pInfo)
    {
        return;
...
{
    NET_ChannelInfo_S stInfo;
    memset(&stInfo, 0, sizeof(stInfo));

    INT32 dwBytesReturned = 0;
    printf("[Client] Calling NET_GetDevConfig to get channel info...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID, 1, NET_GET_CHANNEL_INFO,
        &stInfo, (INT32)sizeof(stInfo), &dwBytesReturned
    );
...
static void DoGetChannelList()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] Calling NET_GetDevConfig to get channel list...\n");
    BOOL bRet = NET_GetDevConfig(
        g_lpUserID, 1, NET_GET_CHANNEL_LIST,
        &stInfo, (INT32)sizeof(stInfo), &dwBytesReturned
    );
...
static void DoGetImageCfg()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] Calling NET_GetDevConfig to get image config...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetImageCfg()
{
    ...
    printf("[Client] Calling NET_SetDevConfig to set image config...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetPreviewInfo()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] Calling NET_GetDevConfig to get preview info...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoSetPreviewInfo()
{
    ...
    printf("[Client] Calling NET_SetDevConfig to set preview info...\n");
    INT32 dwBytesReturnedSet = 0;
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetUpgradeStatusCfg()
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取升级状态...\n");
    bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
...
static void DoGetUpgradeVersionCfg(void)
{
    ...
    printf("[Client] 调用 NET_GetDevConfig 获取可升级版本...\n");
    bRet = NET_GetDevConfig(
        g_lpUserID,
        1,
...
static void DoGetCapturePlanCfg(void)
{
    ...
    memset(&stCfg, 0, sizeof(stCfg));
    printf("[Client] 调用 NET_GetDevConfig 获取告警抓图计划...\n");
...
static void DoSetCapturePlanCfg(void)
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置告警抓图计划...\n");
    PrintCapturePlanCfg(&stCfg);
...
static void DoGetCaptureParamCfg(void)
{
    ...
    memset(&stCfg, 0, sizeof(stCfg));
    printf("[Client] 调用 NET_GetDevConfig 获取告警抓图参数...\n");
...
static void DoSetCaptureParamCfg(void)
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置告警抓图参数...\n");
    PrintCaptureParamCfg(&stCfg);
...
static void DoGetExposureCfg(void)
{
    ...
    memset(&stCfg, 0, sizeof(stCfg));
    printf("[Client] 调用 NET_GetDevConfig 获取曝光信息\n");
...
static void DoSetExposureCfg(void)
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置曝光信息\n");
    PrintExposureCfg(&stCfg);
...
static void DoGetDayNightCfg(void)
{
    ...
    memset(&stCfg, 0, sizeof(stCfg));
    printf("[Client] 调用 NET_GetDevConfig 获取日夜转换信息\n");
...
static void DoSetDayNightCfg(void)
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置日夜转换信息\n");
    PrintDayNightCfg(&stCfg);
...
static void DoGetBackLightCfg(void)
{
    ...
    memset(&stCfg, 0, sizeof(stCfg));
    printf("[Client] 调用 NET_GetDevConfig 获取背光信息\n");
...
static void DoSetBackLightCfg(void)
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置背光信息\n");
    PrintBackLightCfg(&stCfg);
...
static void DoGetDenoiseCfg(void)
{
    ...
    memset(&stCfg, 0, sizeof(stCfg));
    printf("[Client] 调用 NET_GetDevConfig 获取降噪信息\n");
...
static void DoSetDenoiseCfg(void)
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置降噪信息\n");
    PrintDenoiseCfg(&stCfg);
...
static void DoGetWhiteBalanceCfg(void)
{
    ...
    memset(&stCfg, 0, sizeof(stCfg));
    printf("[Client] 调用 NET_GetDevConfig 获取白平衡信息\n");
...
static void DoSetWhiteBalanceCfg(void)
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置白平衡信息\n");
    PrintWhiteBalanceCfg(&stCfg);
...
static BOOL SetVoiceComTalkbackState(BOOL bEnable, const char* localIp)
{
    ...
    if (!bRet)
    {
        printf("[Client][VoiceCom] Set talkback %s failed, Error=%d\n",
               bEnable ? "ON" : "OFF", NET_GetLastError());
    }
    else
    {
...
static void DoVoiceComSendAudioFile()
{
    ...
    if (!NET_StartVoiceCom(g_lpUserID, &stStartInfo, VoiceComRecvCallback, dumpFp))
    {
        printf("[Client][VoiceCom] NET_StartVoiceCom failed, Error=%d\n", NET_GetLastError());
        if (dumpFp)
        {
            fclose(dumpFp);
        }
    ...
    while (true)
    {
        ...
        if (!NET_VoiceComSendData(g_lpUserID, frame.data(), (UINT32)nRead))
        {
            printf("[Client][VoiceCom] send failed at frame=%zu, Error=%d\n",
                   frameCount, NET_GetLastError());
            sendOk = false;
            break;
        }
...
static void DoGetReplayUrl()
{
    ...
    INT32 dwBytesReturned = 0;
    BOOL bRet = false;
    NET_GetReplayUrl(g_lpUserID, &stInfo, &dwBytesReturned);
...
static void DoControlReplayStart()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] Calling NET_ControlReplay START, server will forward AC_PLATFORM_PLAY(%d)...\n",
           DEMO_AC_PLATFORM_PLAY);
    BOOL bRet = NET_ControlReplay(g_lpUserID, &stInfo, &dwBytesReturned);
...
static void DoGetReplayRecordList()
{
    ...
    INT32 dwBytesReturned = 0;
    BOOL bRet = NET_GetReplayRecordList(g_lpUserID, &stInfo, &dwBytesReturned);
...
static void DoSetFaceCompareInfo()
{
    ...
    printf("[Client] 调用 NET_SetDevConfig 设置人脸比对配置...\n");
    INT32 dwBytesReturned = 0;
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetTargetLib()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取目标库...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoAddTargetLib()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_SetDevConfig 添加目标库...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoDelTargetLib()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_SetDevConfig 删除目标库...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoSetTargetLib()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_SetDevConfig 修改目标库...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoGetFaceInfo()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_GetDevConfig 获取人脸...\n");
    BOOL bRet = NET_GetDevConfig(
...
static void DoAddFaceInfo()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_SetDevConfig 添加人脸...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoDelFaceInfo()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_SetDevConfig 删除人脸...\n");
    BOOL bRet = NET_SetDevConfig(
...
static void DoSetFaceInfo()
{
    ...
    INT32 dwBytesReturned = 0;
    printf("[Client] 调用 NET_SetDevConfig 修改人脸...\n");
    BOOL bRet = NET_SetDevConfig(
