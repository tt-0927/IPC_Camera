...
* @note
*/
typedef void(NET_TV_STDCALL *NET_TV_ExceptionCallBack_PF)(NET_TV_IN LPVOID lpUserID,
                                                   NET_TV_IN INT32 dwType,
                                                   NET_TV_IN LPVOID lpExpHandle,
...
*/
typedef void(NET_TV_STDCALL *NET_TV_AlarmCallBack)(NET_TV_OUT INT64 lCommand,
...
* @brief 通道上下线状态回调函数
*/
typedef void(NET_TV_STDCALL *NET_TV_ChannelStatusCallBack)(NET_TV_OUT NET_ChannelInfo_S *pChannelInfo,
                                                    NET_TV_OUT LPVOID lpUserData);
 ...
 * @return NET_TV_TRUE 成功，NET_TV_FALSE 失败（调用 NET_TV_GetLastError() 获取错误码）
 */
 ...
 * @param [in] lpUserData   用户数据
 */
typedef void (NET_TV_STDCALL *NET_TV_RecordFrameCallBack)(NET_TV_IN const NET_RecordFrameInfo_S* pstFrameInfo,
 ...
 * @return NET_TV_TRUE 成功，NET_TV_FALSE 失败；失败原因通过 NET_TV_GetLastError 获取
 */
NET_TV_API BOOL NET_TV_STDCALL
...
typedef void (NET_TV_STDCALL *NET_TV_VoiceComCallBack)(const char* data, unsigned int size, LPVOID lpUserData);
