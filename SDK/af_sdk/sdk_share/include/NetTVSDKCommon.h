...
#define NET_TV_ALARM_STATISTICS_TARGET_MAX_NUM   64
 ...
 * - `dwCtrlType=NET_TV_REPLAY_CTRL_STOP` / `NET_TV_REPLAY_CTRL_PAUSE` / `NET_TV_REPLAY_CTRL_SET_SPEED` 时，优先使用 `szSessionId` 标识会话
