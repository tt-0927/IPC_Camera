 ...
 * @LastEditTime : 2025-12-22 10:14:16
 * @Description  : 公共数据定义
 */
...
/*压缩模式*/
#define COMPRESSMODE OT_COMPRESS_MODE_NONE
...
/********************** Ai_Detect ***********************/
typedef enum _AiDetectChn_E_
{
    AI_DETECT_CHN_HVF = 0,     /* 脸人车模型通道 */
    AI_DETECT_CHN_PET = 1,     /* 宠物模型通道 */
    AI_DETECT_CHN_PACKAGE = 2, /* 包裹模型通道 */
} AiDetectChn_E;
/********************** Ai_Detect ***********************/
