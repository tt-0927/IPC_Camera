...
//  * @LastEditTime : 2025-05-26 10:06:46
//  * @Description  : 图片处理器
//  */
// #pragma once
...
//      * @note
//      */
//     IpcRet_E drawLines(cv::Mat&              editImage,
...
//      * @note
//      */
//     IpcRet_E drawLabel(cv::Mat&               editImage,
...
//      * @note
//      */
//     IpcRet_E drawCenter(cv::Mat&                editImage,
...
//      * @note
//      */
//     IpcRet_E drawBox(cv::Mat&             editImage,
...
//      */
//     IpcRet_E draw(DrawParam_S          stParam,
//                    std::list<BoxInfo_S> listBoxInfo,
//                    char**               pchOutData,
//                    int&                 nOutDataSize);
...
//      * @note
//      */
//     IpcRet_E saveImage(DataFormatType_E   enDataType,
//                         const char*        pchData,
//                         int                nWidth,
//                         int                nHeigh,
...
//      * @note
//      */
//     IpcRet_E saveBinaryDataToFile(const char* pchData, size_t nSize, const char* pchFilePath);
...
//      * @note pchOutData :new出来的，需要调用者释放
//      */
//     IpcRet_E transition(DataFormatType_E enInType,
//                          int              nInWidth,
//                          int              nInHeight,
...
//     void convertToARGB4444(const cv::Mat& rgbaImg, char* outData);
    
//     void convertARGB4444ToRGBA8888(const char* argb4444, uchar* rgba, int width, int height);
// };
