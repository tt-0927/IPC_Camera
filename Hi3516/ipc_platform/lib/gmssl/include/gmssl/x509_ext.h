...
enum {
	X509_non_critical = 0, 	//非关键性的。如果解析器不识别此扩展，则可以忽略它而不影响证书的有效性
	X509_critical = 1,		//关键性的。如果解析器不识别或无法处理此扩展，则应拒绝整个证书
};
