...
td_s32 isp_drv_cfg_bnr_online(ot_vi_pipe vi_pipe, td_bool tnr_en, td_bool initial_en, ot_isp_bnr_ref_mode bnr_ref_mode)
{
    isp_drv_ctx *drv_ctx = TD_NULL;
    ...
    isp_drv_reg_config_bnr_online(vi_pipe, drv_ctx, tnr_en, initial_en, bnr_ref_mode);
...
isp_export_func g_isp_exp_func = {
    ...
    .pfn_isp_close_drc_bypass = isp_drv_close_drc_bypass,
    .pfn_isp_close_drc_var = isp_drv_close_drc_var,
    .pfn_isp_restore_drc = isp_drv_restore_drc,
#endif
    .pfn_isp_cfg_bnr_online = isp_drv_cfg_bnr_online,
#ifdef CONFIG_OT_SYS_KOL_SUPPORT
    .pfn_isp_clear_kol_int_num = isp_clear_kol_int_num,
#endif
};
