...
static td_void cac_dyn_reg_update(ot_vi_pipe vi_pipe, td_u32 iso, isp_cac_dyna_cfg *dyn_cfg, isp_cac *cac_ctx)
{
    ...
    dyn_cfg->edge_thd0 = (td_u16)linear_inter((td_s32)iso, (td_s32)iso1, g_cac_th_rb[0][iso_index_low],
                                              (td_s32)iso2, g_cac_th_rb[0][iso_index_up]);
    dyn_cfg->edge_thd1 = (td_u16)linear_inter((td_s32)iso, (td_s32)iso1, g_cac_th_rb[1][iso_index_low],
                                              (td_s32)iso2, g_cac_th_rb[1][iso_index_up]);
