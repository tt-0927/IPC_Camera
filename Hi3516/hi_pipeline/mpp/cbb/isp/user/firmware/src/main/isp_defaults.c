...
td_void isp_ext_regs_default(ot_vi_pipe vi_pipe)
{
    ...
    ot_ext_system_fe_roi_width_write(vi_pipe, (td_u16)isp_ctx->sys_rect.width);
    ot_ext_system_fe_roi_height_write(vi_pipe, (td_u16)isp_ctx->sys_rect.height);
    ...
    /* isp is_long_edge_stitching for stitch mode */
    ot_ext_system_isp_is_long_edge_stitching_write(vi_pipe, OT_EXT_SYSTEM_ISP_LONG_EDGE_STITCHING_DEFAULT);
...
td_void isp_ext_regs_initialize(ot_vi_pipe vi_pipe)
{
    ...
    isp_check_pointer_void_return(sns_max_resolution);

    ot_ext_system_sensor_max_resolution_width_write(vi_pipe, (td_u16)sns_max_resolution->max_width);
    ot_ext_system_sensor_max_resolution_height_write(vi_pipe, (td_u16)sns_max_resolution->max_height);
