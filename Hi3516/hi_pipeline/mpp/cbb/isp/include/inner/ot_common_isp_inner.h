...
typedef struct {
        td_bool    is_longedge_stitching;
        td_bool    is_rotating180;
        td_s32   overlap_len[0x2 * (OT_GDC_MAX_STITCH_NUM - 1)];
} isp_stitch_transform_info;

typedef struct {
    td_bool enable;                   /* RW; Range:[0, 1]; Format:1.0;Enable/Disable AGamma Function */
    td_u32  scale;                   /* RW; Range:HI3516CV610 = [0xC8, 0x1400]; Format:3.10;
                                         AGamma LUT strength */
} isp_agamma_attr;
