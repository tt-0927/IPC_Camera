...
/* 报警输入或输出地址字符串的最大长度。 */
#define NET_ALARM_ADDRESS_LEN                  NET_TV_LEN_64
/* 报警名称字符串的最大长度。 */
#define NET_ALARM_NAME_LEN                     NET_TV_LEN_64
/* 自定义音频名称字符串的最大长度。 */
#define NET_ALARM_CUSTOM_AUDIO_NAME_LEN        NET_TV_LEN_64
/* 自定义音频文件路径字符串的最大长度。 */
#define NET_ALARM_CUSTOM_AUDIO_PATH_LEN        NET_TV_LEN_256
/* 报警配置可关联的最大复制目标数量。 */
#define NET_ALARM_COPY_TO_MAX_NUM              NET_TV_MAX_ALARM_OUT_NUM
/* 报警配置结构体中保留字段的字节长度。 */
...
/* 抓拍事件中图片引用字符串的最大长度。 */
#define NET_CAPTURE_PICTURE_REFERENCE_MAX_LEN       1024
/* 抓拍事件中时间戳字符串的最大长度。 */
...
#define NET_TV_ALARM_PERSON_TRIP         (NET_TV_ALARM_BASE_AI + 0x27)    // 人员绊倒识别
#define NET_TV_ALARM_ELECTRIC_VEHICLE_IN_ELEVATOR \
                                        (NET_TV_ALARM_BASE_AI + 0x28)    // 电动车进电梯识别
...
#define NET_TV_ALARM_FENCE_CLIMBING      (NET_TV_ALARM_BASE_AI + 0x2C)    // 翻越围栏识别
#define NET_TV_ALARM_BARE_SOIL           (NET_TV_ALARM_BASE_AI + 0x2D)    // 黄土裸露识别
#define NET_TV_ALARM_HOLE_PROTECTION_BAR (NET_TV_ALARM_BASE_AI + 0x2E)    // 洞口防护栏识别
#define NET_TV_ALARM_PEDESTRIAN_INTRUSION \
                                        (NET_TV_ALARM_BASE_AI + 0x2F)    // 行人入侵识别
#define NET_TV_ALARM_HIGH_ALTITUDE_SEATBELT \
                                        (NET_TV_ALARM_BASE_AI + 0x30)    // 高空安全带识别
#define NET_TV_ALARM_CONSTRUCTION_OCCUPY_ROAD \
                                        (NET_TV_ALARM_BASE_AI + 0x31)    // 施工占道识别
#define NET_TV_ALARM_EMERGENCY_LANE_OCCUPANCY \
                                        (NET_TV_ALARM_BASE_AI + 0x32)    // 应急车道占用识别
#define NET_TV_ALARM_REVERSE_DIRECTION   (NET_TV_ALARM_BASE_AI + 0x33)    // 逆行识别
#define NET_TV_ALARM_NON_MOTOR_VEHICLE_INTRUSION \
                                        (NET_TV_ALARM_BASE_AI + 0x34)    // 非机动车入侵识别
#define NET_TV_ALARM_ROAD_PONDING         (NET_TV_ALARM_BASE_AI + 0x35)    // 道路积水识别
#define NET_TV_ALARM_CONGESTION            (NET_TV_ALARM_BASE_AI + 0x36)    // 拥堵识别
#define NET_TV_ALARM_ILLEGAL_LANE_CHANGE  (NET_TV_ALARM_BASE_AI + 0x37)    // 违法变道识别
#define NET_TV_ALARM_SCENE_CHANGE          (NET_TV_ALARM_BASE_AI + 0x38)    // 场景变更识别
#define NET_TV_ALARM_OPEN_FLAME            (NET_TV_ALARM_BASE_AI + 0x39)    // 明火识别


// > 音频智能
#define NET_TV_ALARM_AUDIO_ANOMALY      (NET_TV_ALARM_BASE_AI + 0x50)    // 音频异常
#define NET_TV_ALARM_AUDIO_SUDDEN_RISE  (NET_TV_ALARM_BASE_AI + 0x51)    // 声强陡升检测
#define NET_TV_ALARM_AUDIO_SUDDEN_DROP  (NET_TV_ALARM_BASE_AI + 0x52)    // 声强突降检测
...
typedef enum tagNETTVMediaErrCode
{
    ...
    NET_TV_E_FAIL_TO_GET_PORT_RES               = 1259,     /* 获得播放通道资源失败 Failed to obtain playback channel resources*/
...
typedef enum tagNETTVCfgCmd
{
    ...
    NET_TV_GET_UPGRADESTATUS            = 102,              /* Get upgrade status information */
    NET_TV_SET_UPGRADE                  = 103,              /* Set upgrade information */
    NET_TV_GET_UPGRADEVERSION           = 104,  
    ...
    NET_TV_GET_AUDIOCFG                 = 130,              /* 获取音频配置参数,参见#NET_TV_AUDIO_CFG_S */
    NET_TV_SET_AUDIOCFG                 = 131,              /* 设置音频配置参数,参见#NET_TV_AUDIO_CFG_S */
    ...
    NET_TV_GET_CAPTURE_PLAN_INFO        = 208,              /* 获得抓图计划信息 */
    NET_TV_SET_CAPTURE_PLAN_INFO        = 209,              /* 设置抓图计划信息 */
    NET_TV_GET_CAPTURE_PARAM_INFO       = 210,              /* 获得抓图计划参数 */
    NET_TV_SET_CAPTURE_PARAM_INFO       = 211,              /* 设置抓图计划参数 */
    ...
    NET_TV_GET_PREVIEWINFO              = 224,              /* 获取预览信息 参见NET_TV_PREVIEW_INFO_S */
    NET_TV_SET_PREVIEWINFO              = 225,              /* 设置预览信息 参见NET_TV_PREVIEW_INFO_S */
    ...
    NET_TV_GET_FACECAPTUREOVERLAYINFO   = 249,              /* 获取人脸抓拍叠加信息 参见NET_TV_FACE_CAPTURE_OVERLAY_INFO_S */
    NET_TV_SET_FACECAPTUREOVERLAYINFO   = 250,              /* 设置人脸抓拍叠加信息 参见NET_TV_FACE_CAPTURE_OVERLAY_INFO_S */
    ...
    NET_TV_RESET_PEOPLE_FLOW_STATISTICS   = 410,            /* 立即重置人流统计数据 参见NET_TV_PEOPLE_FLOW_STATISTICS_CFG_S */
    ...
    NET_GET_FLASHING_LIGHT_ALARM_INFO     = 500,            /* 获取闪光报警灯配置，参见 NET_FlashingLightAlarmInfo_S。 */
    NET_SET_FLASHING_LIGHT_ALARM_INFO     = 501,            /* 设置闪光报警灯配置，参见 NET_FlashingLightAlarmInfo_S。 */
    NET_GET_PIR_ALARM_INFO                = 502,            /* 获取人体红外（PIR）报警配置，参见 NET_PirAlarmInfo_S。 */
    NET_SET_PIR_ALARM_INFO                = 503,            /* 设置人体红外（PIR）报警配置，参见 NET_PirAlarmInfo_S。 */
    ...
    NET_TV_TRIGGER_SOUND_LIGHT_ALARM      = 508,            /* 触发声光报警联动事件，参见 NET_SoundLightAlarmTrigger_S。 */
...
{
    INT32               enExpTime;          /* NET_TV_EXPOSURE_TIME_E */
...
{
    INT32               enDayNightMode;     /* NET_TV_DAYNIGHT_MODE_E */
    INT32               nBeginHour;
    INT32               nBeginMinute;
    INT32               nBeginSecond;
    ...
    UINT32              nFilterTime;
    BOOL                bFillLightExp;
    INT32               enLightMode;        /* NET_TV_LIGHT_BRIGHT_MODE_E */
    INT32               enLightType;        /* NET_TV_LIGHT_TYPE_E */
...
{
    INT32               enBackLightArea;    /* NET_TV_BACKLIGHT_AREA_E */
    BOOL                bWdrEnable;
    INT32               nWdrLevel;
    BOOL                bHlsEnable;
    INT32               nHlsLevel;
...
{
    INT32               enDnrMode;          /* NET_TV_DNR_MODE_E */
    UINT32              nDnrLevel;
    UINT32              nSnrLevel;
    UINT32              nTnrLevel;
    BYTE                byRes[64];
...
{
    INT32               enAwbMode;          /* NET_TV_AWB_MODE_E */
    UINT32              nRGain;
    UINT32              nBGain;
    BYTE                byRes[64];
...
{
    CHAR    szRtspMainUrl[NET_TV_MAX_URL_LEN];    /* 主码流 RTSP 地址 */
    CHAR    szRtspSubUrl[NET_TV_MAX_URL_LEN];     /* 子码流 RTSP 地址 */
    INT32   nBrightness;                          /* 亮度 [0,100] */
    INT32   nContrast;                            /* 对比度 [0,100] */
    INT32   nSaturation;                          /* 饱和度 [0,100] */
    INT32   nSharpness;                           /* 锐度 [0,100] */
...
//  */
// typedef struct tagNETTVAlarmAiObjectExInfo
// {
//     UINT32      dwAlarmType;                         /* 报警类型/命令码 */
//     UINT32      dwChannel;                           /* 通道号 */
//     UINT32      dwObjectType;                        /* 目标类型(0:未知 1:人 2:车 ... 可扩展) */
...
//     BYTE        byPanoramaImg[NET_TV_PIC_DATA_MAX_LEN]; /* 全景 JPEG 二进制图片 */
//     UINT32      dwPanoramaImgLen;                    /* 全景 JPEG 图片长度 */
//     BYTE        byObjectImg[NET_TV_PIC_DATA_MAX_LEN]; /* 目标小图 JPEG 二进制图片 */
//     UINT32      dwObjectImgLen;                      /* 目标小图 JPEG 图片长度 */
//     BYTE        byRes[128];                          /* 保留字段 */
// }NET_TV_ALARM_AI_OBJECT_EX_INFO_S, *LPNET_TV_ALARM_AI_OBJECT_EX_INFO_S;
...
/* 动态图片视图：图片内存由调用者持有，SDK 只在同步调用期间读取。 */
typedef struct tagNETTVImageData
{
    const BYTE  *pData;
    UINT32       dwLen;
    UINT32       dwWidth;
    UINT32       dwHeight;
} NET_TV_IMAGE_DATA_S, *LPNET_TV_IMAGE_DATA_S;

/* V2 告警结构使用动态图片视图，保留 V1 定长结构保证旧 ABI 可用。 */
typedef struct tagNETTVAlarmBasicInfoV2
{
    UINT32              dwAlarmType;
    UINT32              dwAlarmInputNumber;
    BYTE                byAlarmOutputNumber[NET_TV_MAX_ALARM_OUT_NUM];
    BYTE                byAlarmRelateChannel[NET_TV_MAX_ALARM_IN_NUM];
    BYTE                byChannel[NET_TV_MAX_ALARM_IN_NUM];
    BYTE                byDiskNumber[NET_TV_LOCAL_DISK_MAX_NUM];
    NET_TV_IMAGE_DATA_S stPanoramaImg;
    INT64               llTimestampMs;
    BYTE                byRes[128];
} NET_TV_ALARM_BASIC_INFO_V2_S, *LPNET_TV_ALARM_BASIC_INFO_V2_S;

typedef struct tagNETTVAlarmRuleInfoV2
{
    UINT32              dwAlarmType;
    UINT32              dwChannel;
    UINT32              dwRuleID;
    UINT32              dwRuleType;
    CHAR                szRuleName[NET_TV_LEN_64];
    UINT32              dwTargetID;
    UINT32              dwObjectType;
    float               fConfidence;
    INT32               nLeft;
    ...
    INT32               nBottom;
    NET_TV_IMAGE_DATA_S stPanoramaImg;
    NET_TV_IMAGE_DATA_S stTargetImg;
    INT64               llTimestampMs;
    BYTE                byRes[128];
} NET_TV_ALARM_RULE_INFO_V2_S, *LPNET_TV_ALARM_RULE_INFO_V2_S;

typedef struct tagNETTVAlarmAiObjectInfoV2
{
    UINT32              dwAlarmType;
    UINT32              dwChannel;
    UINT32              dwObjectType;
    ...
    INT32               nRight;
    INT32               nBottom;
    CHAR                szObjectID[NET_TV_LEN_64];
    NET_TV_IMAGE_DATA_S stPanoramaImg;
    NET_TV_IMAGE_DATA_S stImgData;
    INT64               llTimestampMs;
    BYTE                byRes[32];
} NET_TV_ALARM_AI_OBJECT_INFO_V2_S, *LPNET_TV_ALARM_AI_OBJECT_INFO_V2_S;

typedef struct tagNETTVAlarmFaceCompareInfoV2
{
    UINT32              dwAlarmType;
    UINT32              dwChannel;
    INT64               llTimestampMs;
    ...
    INT32               nSimilarity;
    INT32               nFaceId;
    CHAR                szFaceLibName[NET_TV_FACE_DB_NAME_LEN];
    CHAR                szFaceName[NET_TV_FACE_MEMBER_NAME_LEN];
    CHAR                szLibFacePath[NET_TV_LEN_260];
    CHAR                szCapFacePath[NET_TV_LEN_260];
    CHAR                szCapImagePath[NET_TV_LEN_260];
    NET_TV_IMAGE_DATA_S stLibFaceImg;
    NET_TV_IMAGE_DATA_S stCapFaceImg;
    BYTE                byRes[256];
} NET_TV_ALARM_FACE_COMPARE_INFO_V2_S, *LPNET_TV_ALARM_FACE_COMPARE_INFO_V2_S;

typedef struct tagNETTVAlarmPlateInfoV2
{
    UINT32              dwAlarmType;
    UINT32              dwChannel;
    CHAR                szPlateNumber[NET_TV_LEN_32];
    UINT32              dwPlateColor;
    UINT32              dwVehicleType;
    float               fConfidence;
    UINT32              dwSpeed;
    UINT32              dwLaneNo;
    NET_TV_IMAGE_DATA_S stPlateImg;
    BYTE                byRes[64];
} NET_TV_ALARM_PLATE_INFO_V2_S, *LPNET_TV_ALARM_PLATE_INFO_V2_S;

typedef struct tagNETTVAlarmStatisticsTargetV2
{
    INT32               nTrackID;
    UINT32              dwRuleID;
    UINT32              dwSnapshotType;
    INT32               nLeft;
    INT32               nTop;
    INT32               nRight;
    INT32               nBottom;
    ...
    NET_TV_IMAGE_DATA_S stImgData;
    BYTE                byRes[64];
} NET_TV_ALARM_STATISTICS_TARGET_V2_S, *LPNET_TV_ALARM_STATISTICS_TARGET_V2_S;

typedef struct tagNETTVAlarmStatisticsInfoV2
{
    UINT32                            dwAlarmType;
    UINT32                            dwChannel;
    UINT32                            dwStatisticsType;
    UINT32                            dwRuleID;
    INT64                             llTimestampMs;
    UINT32                            dwReportSeq;
    UINT32                            dwEnterCount;
    UINT32                            dwLeaveCount;
    UINT32                            dwTotalCount;
    UINT32                            dwCurrentPeopleCount;
    UINT32                            dwAverageStayTimeSec;
    UINT32                            dwTargetCount;
    NET_TV_ALARM_STATISTICS_TARGET_V2_S stTargets[NET_TV_ALARM_STATISTICS_TARGET_MAX_NUM];
    NET_TV_IMAGE_DATA_S               stPanoramaImg;
    BYTE                              byRes[256];
} NET_TV_ALARM_STATISTICS_INFO_V2_S, *LPNET_TV_ALARM_STATISTICS_INFO_V2_S;
...
/* 常规联动类型的最大数量。 */
#define NET_TV_TRADITIONAL_LINKAGE_MAX_NUM     7

/* 常规联动类型，取值与 IPC 的 Alarm::LinkageType_E 保持一致。 */
typedef enum tagNETTVTraditionalLinkageType
{
    NET_TV_TRADITIONAL_LINKAGE_SEND_EMAIL             = 1, /* 发送邮件 */
    NET_TV_TRADITIONAL_LINKAGE_UPLOAD_TO_CENTER       = 2, /* 上传中心 */
    NET_TV_TRADITIONAL_LINKAGE_UPLOAD_SD_CARD         = 3, /* 上传 SD 卡 */
    NET_TV_TRADITIONAL_LINKAGE_SOUND                  = 4, /* 声音联动 */
    NET_TV_TRADITIONAL_LINKAGE_FLASHING_LIGHT_ALARM   = 5, /* 闪光报警灯联动 */
    NET_TV_TRADITIONAL_LINKAGE_UPLOAD_PANORAMIC_IMAGE = 6, /* 上传全景图 */
    NET_TV_TRADITIONAL_LINKAGE_UPLOAD_TARGET_IMAGE    = 7  /* 上传目标图 */
} NET_TV_TRADITIONAL_LINKAGE_TYPE_E;
...
typedef struct tagNETTVLinkageList
{
    ...
    INT32       dwTraditionalLinkageCount;           /* 常规联动类型数量 */
    INT32       adwTraditionalLinkage[NET_TV_TRADITIONAL_LINKAGE_MAX_NUM]; /* 常规联动类型数组 */
    BYTE        byRes[256];                         /* 保留字段 */
}NET_TV_LINKAGE_LIST_S, *LPNET_TV_LINKAGE_LIST_S;

/* 以下类型是旧版 NET_TV_* 类型的兼容别名，内存布局完全一致。 */
typedef NET_TV_SCHED_TIME_S NET_SchedTime_S;
typedef NET_TV_ALARM_SCHEDULE_S NET_AlarmSchedule_S;
typedef NET_TV_LINKAGE_LIST_S NET_LinkageList_S;
...
/*
 * 描述：声光报警联动触发请求。
 * 调用 NET_TV_SetDevConfig 并指定 NET_TV_TRIGGER_SOUND_LIGHT_ALARM 时使用。
 * 服务端根据请求中的联动列表更新手动声光报警联动配置，并立即触发一次事件。
 */
typedef struct tagNETSoundLightAlarmTrigger
{
    /* 手动声光报警事件使用的联动配置。 */
    NET_TV_LINKAGE_LIST_S stLinkageList;
    /* 保留字段，调用方应置零。 */
    BYTE abyReserved[NET_ALARM_CONFIG_RESERVED_LEN];
} NET_SoundLightAlarmTrigger_S, *pNET_SoundLightAlarmTrigger_S;
...
typedef struct tagNETAlarmInputInfoList
{
    ...
    /* 报警输入通道配置列表。 */
    NET_AlarmInputInfo_S astAlarmInputs[NET_TV_MAX_ALARM_IN_NUM];
    /* 保留字段，调用方应置零。 */
    BYTE abyReserved[NET_ALARM_CONFIG_RESERVED_LEN];
...
typedef struct tagNETAlarmOutputInfoList
{
    ...
    /* 报警输出通道配置列表。 */
    NET_AlarmOutputInfo_S astAlarmOutputs[NET_TV_MAX_ALARM_OUT_NUM];
    /* 保留字段，调用方应置零。 */
    BYTE abyReserved[NET_ALARM_CONFIG_RESERVED_LEN];
...
/**
 * @struct tagNETTVIntrusionRule
 * @brief 徘徊侦测区域规则参数 Intrusion detection region rule
 */
typedef struct tagNETTVLoiteringRule
{
    ...
    INT32       adwDetectionTarget[8];               /* 检测目标数组 NET_TV_DETECTION_TARGET_E，最多8个 */
    BYTE        byRes[64];                           /* 保留字段 */
}NET_TV_LOITERING_RULE_S, *LPNET_TV_LOITRING_RULE_S;

/**
 * @struct tagNETTVLoiteringAlarmInfo
 * @brief 徘徊侦测告警配置信息 Loitering detection alarm configuration
 ...
 * @brief 人员聚集侦测规则参数 Crowd gathering detection rule
 */
typedef struct tagNETTVCrowdGatheringRule
{
    BOOL        bEnable;                             /* 是否启用 */
    INT32       dwPointCount;                        /* 区域顶点数量，最多32个 */
    FLOAT       afPointX[32];                        /* 区域顶点X坐标 [0.0-1.0] */
    FLOAT       afPointY[32];                        /* 区域顶点Y坐标 [0.0-1.0] */
    INT32       nObjectOccup;                        /* 人体面积占比阈值[1,100] */
    BYTE        byRes[64];                           /* 保留字段 */
...
typedef struct tagNETTVAudioAnomalyAlarmInfo
{
    ...
    BOOL        bUpEnable;                           /* 音量陡升检测是否启用 */
    INT32       nUpSensitivity;                      /* 陡升灵敏度 [1,100] */
    INT32       nUpThreshold;                        /* 陡升阈值 [1,100] */
    BOOL        bDownEnable;                         /* 音量陡降检测是否启用 */
    INT32       nDownSensitivity;                    /* 陡降灵敏度 [1,100] */
    NET_TV_ALARM_SCHEDULE_S stAlarmSchedule;         /* 布防时间 */
    NET_TV_LINKAGE_LIST_S stLinkageList;             /* 联动配置 */
    BYTE        byRes[256];                          /* 保留字段 */
 ...
 * @brief 视频编码参数配置 Video encode config
 * @attention 无
*/
...
/**
 * @brief 人脸抓拍图片叠加配置。
 * @note 用于 NET_TV_GET_FACECAPTUREOVERLAYINFO 和
 *       NET_TV_SET_FACECAPTUREOVERLAYINFO。
 */
typedef struct tagNETTVFaceCaptureOverlayInfo
{
    INT32               nDeviceID;                                      /* 设备编号 */
    CHAR                strMonitoryPointInfo[NET_TV_LEN_256];           /* 监控点信息 */
    BOOL                bOverlayDeviceID;                               /* 是否叠加设备编号 */
    BOOL                bOverlayCaptureTime;                            /* 是否叠加抓拍时间 */
    BOOL                bOverlayMonitoryPointInfo;                      /* 是否叠加监控点信息 */
    NET_TV_OSD_COLOR_E  enFontColor;                                    /* 字体颜色 */
    CHAR                strFontColor[NET_TV_LEN_16];                    /* 自定义 RGB 字体颜色 */
    BYTE                byRes[128];                                     /* 预留字段 */
}NET_TV_FACE_CAPTURE_OVERLAY_INFO_S, *LPNET_TV_FACE_CAPTURE_OVERLAY_INFO_S;


/*
 * 描述：抓拍区域多边形坐标信息。
 * 说明：坐标点个数由 uPointCount 指定，超出 NET_CAPTURE_REGION_POINT_MAX_NUM 的点不会传输。
 */
typedef struct tagNETCapturePolygon
{
    UINT32 uPointCount;
    FLOAT afPointX[NET_CAPTURE_REGION_POINT_MAX_NUM];
    FLOAT afPointY[NET_CAPTURE_REGION_POINT_MAX_NUM];
    BYTE abyReserved[32];
} NET_CapturePolygon_S, *pNET_CapturePolygon_S;

/*
 * 描述：人脸抓拍推送信息。
 * 说明：人脸特写图和全景图均为 JPEG 原始二进制数据。
 */
typedef struct tagNETFaceCapturePushInfo
{
    BOOL bMale;
    INT32 nAgeLabel;
    BOOL bGlasses;
    ...
    UINT32 uFaceImgLen;
    BYTE byFaceImg[NET_TV_PIC_DATA_MAX_LEN];
    UINT32 uPanoramaImgLen;
    BYTE byPanoramaImg[NET_TV_PIC_DATA_MAX_LEN];
    CHAR strTimestamp[NET_CAPTURE_TIMESTAMP_MAX_LEN];
    BYTE abyReserved[64];
} NET_FaceCapturePushInfo_S, *pNET_FaceCapturePushInfo_S;

/*
 * 描述：行人抓拍推送信息。
 * 说明：行人特写图和全景图均为 JPEG 原始二进制数据。
 */
typedef struct tagNETPersonCapturePushInfo
{
    BOOL bMale;
    INT32 nAgeLabel;
    BOOL bBag;
    ...
    BYTE byPersonImg[NET_TV_PIC_DATA_MAX_LEN];
    UINT32 uPanoramaImgLen;
    BYTE byPanoramaImg[NET_TV_PIC_DATA_MAX_LEN];
    CHAR strTimestamp[NET_CAPTURE_TIMESTAMP_MAX_LEN];
    BYTE abyReserved[64];
} NET_PersonCapturePushInfo_S, *pNET_PersonCapturePushInfo_S;

/*
 * 描述：机动车抓拍推送信息。
 * 说明：机动车特写图和全景图均为 JPEG 原始二进制数据。
 */
typedef struct tagNETMotorvehicleCapturePushInfo
{
    ...
    BYTE byTargetImg[NET_TV_PIC_DATA_MAX_LEN];
    UINT32 uPanoramaImgLen;
    BYTE byPanoramaImg[NET_TV_PIC_DATA_MAX_LEN];
    CHAR strTimestamp[NET_CAPTURE_TIMESTAMP_MAX_LEN];
    BYTE abyReserved[64];
} NET_MotorvehicleCapturePushInfo_S, *pNET_MotorvehicleCapturePushInfo_S;

/*
 * 描述：非机动车抓拍推送信息。
 * 说明：非机动车特写图和全景图均为 JPEG 原始二进制数据。
 */
typedef struct tagNETNonMotorvehicleCapturePushInfo
{
    INT32 nVehicleType;
    INT32 nVehicleColor;
    UINT32 uTargetImgLen;
 ...
 * @param [IN]  dwChannelID  通道号
 * @param [OUT] pCap         音频编码能力集结构体指针(多码流)
 * @return NET_TV_E_SUCCEED 成功, 其他值失败
 */
typedef NET_TV_COMMON_ECODE_E (*NET_TV_CB_GetAudioCap)(INT32 dwChannelID, 
 ...
 * @return TRUE表示成功,其他表示失败
 */
NET_TV_API BOOL STDCALL NET_TV_SERVER_RegisterCb_GetAudioEncodeCap(NET_TV_CB_GetAudioCap pCb);
