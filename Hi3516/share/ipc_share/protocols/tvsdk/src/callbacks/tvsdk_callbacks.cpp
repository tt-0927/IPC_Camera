...
static NET_COMMON_ECODE_E cb_device_control(pNET_DeviceControlInfo_S pCtrlInfo)
{
    ...
    if (pCtrlInfo->uSize != sizeof(NET_DEVICE_CONTROL_TYPE_E) || pCtrlInfo->uChannelID <= 0 || pCtrlInfo->uDurationMs < 0 || pCtrlInfo->uDurationMs > 3000000)
    {
        return NET_E_INVALID_PARAM;
    }
...
void register_all()
{
    ...
    NET_SERVER_RegisterCb_GetOsdCap(cb_get_osd_cap);
    NET_SERVER_RegisterCb_GetDeviceCfg(cb_get_device_cfg);
    NET_SERVER_RegisterCb_SetDeviceCfg(cb_set_device_cfg);
    NET_SERVER_RegisterCb_GetNtpCfg(cb_get_ntp_cfg);
    NET_SERVER_RegisterCb_SetNtpCfg(cb_set_ntp_cfg);
    NET_SERVER_RegisterCb_GetStreamCfg(cb_get_stream_cfg);
    NET_SERVER_RegisterCb_SetStreamCfg(cb_set_stream_cfg);
    NET_SERVER_RegisterCb_GetRtspUrl(cb_get_rtsp_url);
    NET_SERVER_RegisterCb_GetOsdCapCfg(cb_get_osd_cap_cfg);
    NET_SERVER_RegisterCb_SetOsdCapCfg(cb_set_osd_cap_cfg);

    NET_SERVER_RegisterCb_GetImageCfg(cb_get_image_cfg);
    NET_SERVER_RegisterCb_SetImageCfg(cb_set_image_cfg);
    NET_SERVER_RegisterCb_GetNetworkCfg(cb_get_network_cfg);
    NET_SERVER_RegisterCb_SetNetworkCfg(cb_set_network_cfg);
    NET_SERVER_RegisterCb_GetPrivacyMaskCfg(cb_get_privacy_mask_cfg);
    NET_SERVER_RegisterCb_SetPrivacyMaskCfg(cb_set_privacy_mask_cfg);
    NET_SERVER_RegisterCb_GetPreviewInfo(cb_get_preview_info);
    NET_SERVER_RegisterCb_SetPreviewInfo(cb_set_preview_info);
    NET_SERVER_RegisterCb_GetTamperAlarm(cb_get_tamper_alarm);
    NET_SERVER_RegisterCb_SetTamperAlarm(cb_set_tamper_alarm);
    NET_SERVER_RegisterCb_GetMotionAlarm(cb_get_motion_alarm);
    NET_SERVER_RegisterCb_SetMotionAlarm(cb_set_motion_alarm);
    NET_SERVER_RegisterCb_GetSceneChangeAlarm(cb_get_scene_change_alarm);
    NET_SERVER_RegisterCb_SetSceneChangeAlarm(cb_set_scene_change_alarm);
    NET_SERVER_RegisterCb_GetCrowGatheringAlarm(cb_get_crowd_gathering_alarm);
    NET_SERVER_RegisterCb_SetCrowGatheringAlarm(cb_set_crowd_gathering_alarm);
    NET_SERVER_RegisterCb_GetCrossLineAlarm(cb_get_cross_line_alarm);
    NET_SERVER_RegisterCb_SetCrossLineAlarm(cb_set_cross_line_alarm);

#if defined(SCENE_INTELLIGENCE) || CAP_AI_GARBAGE_DETECT
    NET_SERVER_RegisterCb_GetGarbageExposureCfg(cb_get_garbage_exposure_cfg);
    NET_SERVER_RegisterCb_SetGarbageExposureCfg(cb_set_garbage_exposure_cfg);
    NET_SERVER_RegisterCb_GetGarbageOverflowCfg(cb_get_garbage_overflow_cfg);
    NET_SERVER_RegisterCb_SetGarbageOverflowCfg(cb_set_garbage_overflow_cfg);
#endif

#ifdef SCENE_INTELLIGENCE
    NET_SERVER_RegisterCb_GetManholeCoverAbnormalCfg(cb_get_manhole_cover_abnormal_cfg);
    NET_SERVER_RegisterCb_SetManholeCoverAbnormalCfg(cb_set_manhole_cover_abnormal_cfg);
    NET_SERVER_RegisterCb_GetSleepOnDutyCfg(cb_get_sleep_on_duty_cfg);
    NET_SERVER_RegisterCb_SetSleepOnDutyCfg(cb_set_sleep_on_duty_cfg);
    NET_SERVER_RegisterCb_GetElectricVehicleInElevatorCfg(cb_get_electric_vehicle_in_elevator_cfg);
    NET_SERVER_RegisterCb_SetElectricVehicleInElevatorCfg(cb_set_electric_vehicle_in_elevator_cfg);
    NET_SERVER_RegisterCb_GetPersonFallDownCfg(cb_get_person_fall_down_cfg);
    NET_SERVER_RegisterCb_SetPersonFallDownCfg(cb_set_person_fall_down_cfg);
    NET_SERVER_RegisterCb_GetConstructionOccupyRoadCfg(cb_get_construction_occupy_road_cfg);
    NET_SERVER_RegisterCb_SetConstructionOccupyRoadCfg(cb_set_construction_occupy_road_cfg);
    NET_SERVER_RegisterCb_GetCongestionCfg(cb_get_congestion_cfg);
    NET_SERVER_RegisterCb_SetCongestionCfg(cb_set_congestion_cfg);
    NET_SERVER_RegisterCb_GetLicensePlateRecognitionCfg(cb_get_license_plate_recognition_cfg);
    NET_SERVER_RegisterCb_SetLicensePlateRecognitionCfg(cb_set_license_plate_recognition_cfg);
    NET_SERVER_RegisterCb_GetHighAltitudeSeatbeltCfg(cb_get_high_altitude_seatbelt_cfg);
    NET_SERVER_RegisterCb_SetHighAltitudeSeatbeltCfg(cb_set_high_altitude_seatbelt_cfg);
    NET_SERVER_RegisterCb_GetSafetyHelmetCfg(cb_get_safety_helmet_cfg);
    NET_SERVER_RegisterCb_SetSafetyHelmetCfg(cb_set_safety_helmet_cfg);
    NET_SERVER_RegisterCb_GetPersonFallCfg(cb_get_person_fall_cfg);
    NET_SERVER_RegisterCb_SetPersonFallCfg(cb_set_person_fall_cfg);
    NET_SERVER_RegisterCb_GetPhoneUsageCfg(cb_get_phone_usage_cfg);
    NET_SERVER_RegisterCb_SetPhoneUsageCfg(cb_set_phone_usage_cfg);
    NET_SERVER_RegisterCb_GetSmokingCfg(cb_get_smoking_cfg);
    NET_SERVER_RegisterCb_SetSmokingCfg(cb_set_smoking_cfg);
    NET_SERVER_RegisterCb_GetOpenFlameCfg(cb_get_open_flame_cfg);
    NET_SERVER_RegisterCb_SetOpenFlameCfg(cb_set_open_flame_cfg);
    NET_SERVER_RegisterCb_GetBareSoilCfg(cb_get_bare_soil_cfg);
    NET_SERVER_RegisterCb_SetBareSoilCfg(cb_set_bare_soil_cfg);
    NET_SERVER_RegisterCb_GetHoleProtectionBarCfg(cb_get_hole_protection_bar_cfg);
    NET_SERVER_RegisterCb_SetHoleProtectionBarCfg(cb_set_hole_protection_bar_cfg);
    NET_SERVER_RegisterCb_GetReflectiveClothingCfg(cb_get_reflective_clothing_cfg);
    NET_SERVER_RegisterCb_SetReflectiveClothingCfg(cb_set_reflective_clothing_cfg);
#endif

    NET_SERVER_RegisterCb_GetPetRecognitionInfo(cb_get_pet_recognition_info);
    NET_SERVER_RegisterCb_SetPetRecognitionInfo(cb_set_pet_recognition_info);
#ifdef SCENE_INTELLIGENCE
    NET_SERVER_RegisterCb_GetClimbFenceInfo(cb_get_climb_fence_info);
    NET_SERVER_RegisterCb_SetClimbFenceInfo(cb_set_climb_fence_info);
    NET_SERVER_RegisterCb_GetDimissionInfo(cb_get_dimission_info);
    NET_SERVER_RegisterCb_SetDimissionInfo(cb_set_dimission_info);
    NET_SERVER_RegisterCb_GetIllegalLaneInfo(cb_get_illegal_lane_info);
    NET_SERVER_RegisterCb_SetIllegalLaneInfo(cb_set_illegal_lane_info);
    NET_SERVER_RegisterCb_GetRetrogradeInfo(cb_get_retrograde_info);
    NET_SERVER_RegisterCb_SetRetrogradeInfo(cb_set_retrograde_info);
    NET_SERVER_RegisterCb_GetNonmotorVehicleIntrusionInfo(cb_get_nonmotor_vehicle_intrusion_info);
    NET_SERVER_RegisterCb_SetNonmotorVehicleIntrusionInfo(cb_set_nonmotor_vehicle_intrusion_info);
    NET_SERVER_RegisterCb_GetOccupationEmergencyInfo(cb_get_occupation_emergency_info);
    NET_SERVER_RegisterCb_SetOccupationEmergencyInfo(cb_set_occupation_emergency_info);
    NET_SERVER_RegisterCb_GetPedestrianIntrusionInfo(cb_get_pedestrian_intrusion_info);
    NET_SERVER_RegisterCb_SetPedestrianIntrusionInfo(cb_set_pedestrian_intrusion_info);
    NET_SERVER_RegisterCb_GetSmokeFireCfg(cb_get_smoke_fire_cfg);
    NET_SERVER_RegisterCb_SetSmokeFireCfg(cb_set_smoke_fire_cfg);
    NET_SERVER_RegisterCb_GetRoadPondingCfg(cb_get_road_ponding_cfg);
    NET_SERVER_RegisterCb_SetRoadPondingCfg(cb_set_road_ponding_cfg);
#endif

#if CAP_AI_PEOPLE_STATISTICS
    NET_SERVER_RegisterCb_GetPeopleFlowStatisticsCfg(cb_get_people_flow_statistics_cfg);
    NET_SERVER_RegisterCb_SetPeopleFlowStatisticsCfg(cb_set_people_flow_statistics_cfg);
    NET_SERVER_RegisterCb_ResetPeopleFlowStatistics(cb_reset_people_flow_statistics);
    NET_SERVER_RegisterCb_GetPeopleDensityDetectionCfg(cb_get_people_density_detection_cfg);
    NET_SERVER_RegisterCb_SetPeopleDensityDetectionCfg(cb_set_people_density_detection_cfg);
#endif

    NET_SERVER_RegisterCb_GetIntrusionAlarm(cb_get_intrusion_alarm);
    NET_SERVER_RegisterCb_SetIntrusionAlarm(cb_set_intrusion_alarm);
    NET_SERVER_RegisterCb_GetLoiteringAlarm(cb_get_loitering_alarm);
    NET_SERVER_RegisterCb_SetLoiteringAlarm(cb_set_loitering_alarm);
    NET_SERVER_RegisterCb_GetAudioAnomalyAlarm(cb_get_audio_anomaly_alarm);
    NET_SERVER_RegisterCb_SetAudioAnomalyAlarm(cb_set_audio_anomaly_alarm);
    NET_SERVER_RegisterCb_GetParkingAlarm(cb_get_parking_detect_alarm);
    NET_SERVER_RegisterCb_SetParkingAlarm(cb_set_parking_detect_alarm);
    NET_SERVER_RegisterCb_GetUnattendedObjectAlarm(cb_get_unattended_object_alarm);
    NET_SERVER_RegisterCb_SetUnattendedObjectAlarm(cb_set_unattended_object_alarm);
    NET_SERVER_RegisterCb_GetObjectRemovalAlarm(cb_get_object_removal_alarm);
    NET_SERVER_RegisterCb_SetObjectRemovalAlarm(cb_set_object_removal_alarm);

    NET_SERVER_RegisterCb_GetUpgradeStatus(cb_get_upgrade_status);
    NET_SERVER_RegisterCb_SetUpgrade(cb_set_upgrade);
    NET_SERVER_RegisterCb_GetUpgradeVersion(cb_get_upgrade_version);

    NET_SERVER_RegisterCb_GetCapturePlanInfo(cb_get_capture_plan_info);
    NET_SERVER_RegisterCb_SetCapturePlanInfo(cb_set_capture_plan_info);
    NET_SERVER_RegisterCb_GetCaptureParamInfo(cb_get_capture_param_info);
    NET_SERVER_RegisterCb_SetCaptureParamInfo(cb_set_capture_param_info);

    NET_SERVER_RegisterCb_GetExposureInfo(cb_get_exposure_info);
    NET_SERVER_RegisterCb_SetExposureInfo(cb_set_exposure_info);
    NET_SERVER_RegisterCb_GetDayNightInfo(cb_get_daynight_info);
    NET_SERVER_RegisterCb_SetDayNightInfo(cb_set_daynight_info);
    NET_SERVER_RegisterCb_GetBackLightInfo(cb_get_backlight_info);
    NET_SERVER_RegisterCb_SetBackLightInfo(cb_set_backlight_info);
    NET_SERVER_RegisterCb_GetDenoiseInfo(cb_get_denoise_info);
    NET_SERVER_RegisterCb_SetDenoiseInfo(cb_set_denoise_info);
    NET_SERVER_RegisterCb_GetWhiteBalanceInfo(cb_get_whitebalance_info);
    NET_SERVER_RegisterCb_SetWhiteBalanceInfo(cb_set_whitebalance_info);
    
    NET_SERVER_RegisterCb_SetTalkbackState(cb_set_talkback_state);
    NET_SERVER_RegisterCb_SetTalkbackToStream(cb_set_talkback_to_stream);
    NET_SERVER_RegisterCb_GetTalkbackFromStream(cb_get_talkback_from_stream);
    NET_SERVER_RegisterCb_SetReplayTalkback(cb_set_replay_talkback);

    NET_SERVER_RegisterCb_GetAudioCfg(cb_get_audio_cfg);
    NET_SERVER_RegisterCb_SetAudioCfg(cb_set_audio_cfg);
    NET_SERVER_RegisterCb_GetEnterRegionAlarm(cb_get_enter_region_alarm);
    NET_SERVER_RegisterCb_SetEnterRegionAlarm(cb_set_enter_region_alarm);
    NET_SERVER_RegisterCb_GetLeaveRegionAlarm(cb_get_leave_region_alarm);
    NET_SERVER_RegisterCb_SetLeaveRegionAlarm(cb_set_leave_region_alarm);
