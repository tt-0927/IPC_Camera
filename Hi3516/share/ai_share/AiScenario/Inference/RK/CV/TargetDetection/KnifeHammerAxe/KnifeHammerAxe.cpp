/*
 * @FilePath     : KnifeHammerAxe.cpp
 * @Author       : 廖尔涛 liaoet@kfb.cn
 * @Date         : 2024-08-15 16:29:52
 * @LastEditors  : 廖尔涛 liaoet@kfb.cn
 * @LastEditTime : 2024-08-15 16:29:52
 * @Description  : 危险物品检测算法
 */
#include "KnifeHammerAxe.hpp"

#include <cstring>

#include "dlog.h"

InferenceV1_0_NS::CKnifeHammerAxe::CKnifeHammerAxe(std::string strModelPath)
...
InferenceV1_0_NS::CKnifeHammerAxe::~CKnifeHammerAxe()
{
    if (m_postProcess)
    {
        /* 后处理去初始化 */
...
/* 推理数据 */
bool InferenceV1_0_NS::CKnifeHammerAxe::inference(
