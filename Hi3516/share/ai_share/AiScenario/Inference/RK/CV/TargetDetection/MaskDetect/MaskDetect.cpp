 ...
 * @Description  : 口罩检测算法
 */
#include "MaskDetect.hpp"

#include <cstring>

#include "dlog.h"

InferenceV1_0_NS::CMaskDetect::CMaskDetect(std::string strModelPath)
...
InferenceV1_0_NS::CMaskDetect::~CMaskDetect()
{
    if (m_postProcess)
    {
        /* 后处理去初始化 */
...
/* 推理数据 */
bool InferenceV1_0_NS::CMaskDetect::inference(
