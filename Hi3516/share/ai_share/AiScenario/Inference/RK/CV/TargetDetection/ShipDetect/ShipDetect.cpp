 ...
 * @Description  : 船只检测算法
 */
#include "ShipDetect.hpp"

#include <cstring>

#include "dlog.h"

InferenceV1_0_NS::CShipDetect::CShipDetect(std::string strModelPath)
...
InferenceV1_0_NS::CShipDetect::~CShipDetect()
{
    if (m_postProcess)
    {
        /* 后处理去初始化 */
...
/* 推理数据 */
bool InferenceV1_0_NS::CShipDetect::inference(
