/*
 * @FilePath     : StudentBehavior.cpp
 * @Author       : 严泽辉 yanzeh@kfb.cn
 * @Date         : 2024-05-31 09:40:49
...
InferenceV1_0_NS::CStudentBehavior::CStudentBehavior(std::string strModelPath)
...
InferenceV1_0_NS::CStudentBehavior::~CStudentBehavior()
{
    if (m_postProcess)
    {
        /* 后处理去初始化 */
...
/* 推理数据 */
bool InferenceV1_0_NS::CStudentBehavior::inference(
