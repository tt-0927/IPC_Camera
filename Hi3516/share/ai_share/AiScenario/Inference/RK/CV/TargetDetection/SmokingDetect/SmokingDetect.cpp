 ...
 * @Description  : 抽烟检测算法
 */
#include "SmokingDetect.hpp"

#include <cstring>

#include "dlog.h"

InferenceV1_0_NS::CSmokingDetect::CSmokingDetect(std::string strModelPath)
...
InferenceV1_0_NS::CSmokingDetect::~CSmokingDetect()
{
    if (m_postProcess)
    {
        /* 后处理去初始化 */
...
/* 推理数据 */
bool InferenceV1_0_NS::CSmokingDetect::inference(
