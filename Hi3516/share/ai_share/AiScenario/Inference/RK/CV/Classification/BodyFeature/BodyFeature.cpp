...
InferenceV1_0_NS::CBodyFeature::CBodyFeature(std::string strModelPath)
    : CCVInferenceRK(strModelPath)
{
}

InferenceV1_0_NS::CBodyFeature::~CBodyFeature()
{
}

/* 推理数据 */
bool InferenceV1_0_NS::CBodyFeature::inference(
