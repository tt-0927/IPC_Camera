/*
 * @FilePath     : HeadCountV2_0.cpp
 * @Author       : 严泽辉 yanzeh@kfb.cn
 * @Date         : 2024-05-22 20:19:15
 * @LastEditors: 李辉 lihui@kfb.cn
 * @LastEditTime: 2024-10-31 16:30:49
 * @Description  : 人少场景
 */
...
Scenario_NS::CHeadCountV2_0::CHeadCountV2_0(AiScenario_NS::InParam_S stInParam)
...
Scenario_NS::CHeadCountV2_0::~CHeadCountV2_0()
{
    unInit();
}

/* 初始化 */
bool Scenario_NS::CHeadCountV2_0::init()
{
    bool bRet = false;
...
/* 反初始化 */
bool Scenario_NS::CHeadCountV2_0::unInit()
{
    if (m_pInference)
    {
        delete m_pInference;
...
/* 处理数据 */
bool Scenario_NS::CHeadCountV2_0::process(AiScenario_NS::CVData_S stInData, char*& pchOutData, int& nDataSize)
{
...
/* 处理数据 */
bool Scenario_NS::CHeadCountV2_0::process(
...
/* 释放处理结果 */
bool Scenario_NS::CHeadCountV2_0::releaseData(char*& pchOutData)
{
    if (!pchOutData)
    {
        return false;
...
bool Scenario_NS::CHeadCountV2_0::convertToJson(
