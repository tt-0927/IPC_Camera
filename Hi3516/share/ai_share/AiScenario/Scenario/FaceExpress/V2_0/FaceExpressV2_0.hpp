...
{
    class CFaceExpressV2_0 : public CScenarioBase
    {
    public:

        CFaceExpressV2_0(AiScenario_NS::InParam_S stInParam);
        ~CFaceExpressV2_0();
