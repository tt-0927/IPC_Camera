...
#ifndef __HEAD_DETECT_DETECT_H__
#define __HEAD_DETECT_DETECT_H__
...
class HEAD_DETECT_DETECT
{
	...
	public:
		...
		/**
		  ...
		  * return 成功-> 0， 失败-> 1
		* */
		int DetectHeadRgb(cv::Mat aInputImg,std::vector<float> &vPoints);
		...
		* */
		    HEAD_DETECT_DETECT();
		    HEAD_DETECT_DETECT(char* pModelPath);
...
#endif // __HEAD_DETECT_DETECT_H__
