...
#ifndef __RK_FIRE_DETECT_H__
#define __RK_FIRE_DETECT_H__
...
class RK_FIRE_DETECT
{
	...
	public:
		...
		/**
		  ...
		  * return 成功-> 0， 失败-> 1
		* */
		int DetectFireRgb(cv::Mat aInputImg,std::vector<float> &vPoints);
		...
		* */
		    RK_FIRE_DETECT();
		    RK_FIRE_DETECT(char* pModelPath);
