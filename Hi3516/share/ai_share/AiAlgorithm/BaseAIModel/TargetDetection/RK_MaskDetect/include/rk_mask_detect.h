...
#ifndef __MASK_DETECT_DETECT_H__
#define __MASK_DETECT_DETECT_H__
...
class MASK_DETECT_DETECT
{
	...
	public:
		...
		/**
		  ...
		  * return 成功-> 0， 失败-> 1
		* */
		int DetectMaskRgb(cv::Mat aInputImg,std::vector<float> &vPoints);
		...
		* */
		    MASK_DETECT_DETECT();
		    MASK_DETECT_DETECT(char* pModelPath);
...
#endif // __MASK_DETECT_DETECT_H__
