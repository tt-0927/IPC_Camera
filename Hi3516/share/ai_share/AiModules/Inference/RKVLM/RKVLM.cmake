...
# 文件  
set (SRC_PATH
    ${CMAKE_CURRENT_LIST_DIR}/../../../rk_include

    ${CMAKE_CURRENT_LIST_DIR}/rknnMode
   
    ${CMAKE_CURRENT_LIST_DIR}/rkllmMode
...
if(JSON_ENABLE_DEMO)
include_directories(${CMAKE_CURRENT_LIST_DIR}/../../Inference/Common/json)
aux_source_directory(${CMAKE_CURRENT_LIST_DIR}/../../Inference/Common/json JSON_SOURCES)
endif()
...
# 设置的源文件
target_sources(${INFERENCE_NAME} INTERFACE ${MODULE_SOURCES} ${JSON_SOURCES})

link_directories(${CMAKE_CURRENT_LIST_DIR}/../../../lib/rv1126b)
