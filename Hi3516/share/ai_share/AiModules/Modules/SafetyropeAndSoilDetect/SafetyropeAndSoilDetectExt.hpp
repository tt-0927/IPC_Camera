/**
 * @file SafetyropeAndSoilDetectExt.hpp
...
namespace SafetyropeAndSoilDetect_NS
{
    ...
    /* 高空安全带识别参数 */
    typedef struct _SafetyropeParam_
    {
        bool                   bEnable;     /* 是否分析 */
    ...
    {
        SafetyropeParam_S stSafetyropeParam;
        SoilParam_S   stSoilParam;
    ...
    {
        bool           bSafetyrope = false;                     /* 是否高空安全带触发 */
        bool           bSoil = false;                           /* 是否黄土裸露触发 */
    } Result_S;
