...
namespace FireDetect_NS
{
    ...
    /* 烟火检测参数 */
    typedef struct _SmokeFireParam_
    {
        bool                   bEnable;   /* 是否分析 */
     ...
     /* 明 火检测参数 */
    typedef struct _OpenFlameParam_
    {
        bool                   bEnable;   /* 是否分析 */
        unsigned int           nDetectFrame = 1;    /* 检测多少帧才触发 */
    } OpenFlameParam_S;
    ...
    {
        SmokeFireParam_S stSmokeFireParam;
        OpenFlameParam_S stOpenFlameParam;
    ...
    {
        bool           bSmokeFire   = false;         /* 是否烟火触发 */
        bool           bOpenFlame   = false;         /* 是否明火触发 */
    } Result_S;
