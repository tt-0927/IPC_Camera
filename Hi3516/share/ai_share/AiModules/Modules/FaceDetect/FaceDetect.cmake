set(MODULE_NAME "FaceDetect_Module")

# 必须在前面
add_library(${MODULE_NAME} INTERFACE)

if("${AIMODULES}" STREQUAL "RK35XX")
    include(${CMAKE_CURRENT_LIST_DIR}/../../Inference/RK/TargetDetection/Retinaface/Retinaface.cmake)
    include(${CMAKE_CURRENT_LIST_DIR}/../../Inference/RK/TargetDetection/Yolov5Face/Yolov5Face.cmake)
endif()
...
# 链接库路径
if("${AIMODULES}" STREQUAL "RK35XX")
    set(MODULE_DEPS FaceDetect_RK Yolov5Face_RK)
else()
    set(MODULE_DEPS "")
endif()
