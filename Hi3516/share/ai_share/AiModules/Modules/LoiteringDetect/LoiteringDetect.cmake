set(MODULE_NAME "LoiteringDetect_Module")
...
if("${AIMODULES}" STREQUAL "RK35XX" AND NOT DEFINED INCLUDE_HUMAN_TRACK)
    # 设置标志变量，表示已经包含过
    set(INCLUDE_HUMAN_TRACK TRUE CACHE INTERNAL "Flag to indicate ByteTrack/HumanDetect.cmake has been included")

    # 包含 ByteTrack.cmake HumanDetect.cmake
    include(${CMAKE_CURRENT_LIST_DIR}/../../Inference/CPU/Tracker/ByteTrack/ByteTrack.cmake)
    include(${CMAKE_CURRENT_LIST_DIR}/../../Inference/RK/TargetDetection/HumanDetect/HumanDetect.cmake)
endif()
