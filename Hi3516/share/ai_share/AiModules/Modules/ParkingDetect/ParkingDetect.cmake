set(MODULE_NAME "ParkingDetect_Module")

# 必须在前面
add_library(${MODULE_NAME} INTERFACE)

if("${AIMODULES}" STREQUAL "RK35XX" AND NOT DEFINED INCLUDE_HUMAN_TRACK)
    # 设置标志变量，表示已经包含过
    set(INCLUDE_HUMAN_TRACK TRUE CACHE INTERNAL "Flag to indicate ByteTrack.cmake has been included")

    # 包含 ByteTrack.cmake
    include(${CMAKE_CURRENT_LIST_DIR}/../../Inference/CPU/Tracker/ByteTrack/ByteTrack.cmake)
endif()

if("${AIMODULES}" STREQUAL "RK35XX")
    include(${CMAKE_CURRENT_LIST_DIR}/../../Inference/RK/TargetDetection/MotorizedDetect/MotorizedDetect.cmake)
endif()
...
# 链接库路径
if("${AIMODULES}" STREQUAL "RK35XX")
    set(MODULE_DEPS ByteTrack_CPU MotorizedDetect_RK)
else()
