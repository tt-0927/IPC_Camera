...
static void *videoFrameHandlThr(void *pParam)
{
    ...
    /* ---------------------- 模型初始化 ------------------------ */
    HighAltitudeDetect_NS::InParam_S stInParam;
    stInParam.strModelPath = "./RK3588_Face_Detect_V2.0.rknn";
    /* 初始高空抛物检测 */
    HighAltitudeDetect_NS::CHighAltitudeDetectV1_0 *demo = new HighAltitudeDetect_NS::CHighAltitudeDetectV1_0(stInParam);
    ...
    HighAltitudeDetect_NS::InData_S stInData;
    ...
    while (!g_bExit)
    {
        ...
        if (nstatus == 0 && naddr != 0)
        {
            ...
            std::vector<HighAltitudeDetect_NS::Result_S> vOutData;
            { /*---------------------------------- 模型推理 ------------------------------------ */
                /* ================================ 开始计时 ===================================== */
            ...
            { /* ---------------------------------- 显示函数 ----------------------------------  */
                ...
                {
                    // std::cout << "Bounding box: x=" << vOutData[i].fX
                    //         << ", y=" << vOutData[i].fY
                    //         << ", width=" << vOutData[i].fWidth
                    //         << ", height=" << vOutData[i].fHeight << std::endl;
