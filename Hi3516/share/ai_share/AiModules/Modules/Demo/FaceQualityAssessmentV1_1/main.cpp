...
void AI()
{
    ...
    stFQAInParam.strModelPath = "./RK3588_Face_Evaluate_V1.1.rknn";
    /* 初始化车牌识别检测 */
    FaceQualityAssessment_NS::CFaceQualityAssessmentV1_1 *FQA = new FaceQualityAssessment_NS::CFaceQualityAssessmentV1_1(stFQAInParam);
    bFlag = FQA->init();
    if (!bFlag)
    {
        printf("模型初始化失败\n");
