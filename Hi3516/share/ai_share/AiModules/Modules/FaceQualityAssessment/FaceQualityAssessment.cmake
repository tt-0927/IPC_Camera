set(MODULE_NAME "FaceQualityAssessment_Module")

# 必须在前面
add_library(${MODULE_NAME} INTERFACE)

if("${AIMODULES}" STREQUAL "RK35XX")
    include(${CMAKE_CURRENT_LIST_DIR}/../../Inference/RK/Classification/FaceQualityAssessment/FaceQualityAssessment.cmake)
endif()
...
# 链接库路径
if("${AIMODULES}" STREQUAL "RK35XX")
    set(MODULE_DEPS FaceQualityAssessment_RK)
else()
    set(MODULE_DEPS "")
endif()
