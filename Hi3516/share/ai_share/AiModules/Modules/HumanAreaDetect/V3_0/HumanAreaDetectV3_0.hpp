/*
 * @FilePath     : HumanAreaDetectV3_0.hpp
 * @Author       : 严泽辉 yanzeh@kfb.cn
 * @Date         : 2024-09-29 13:59:59
 * @LastEditors: 梁浩尧 lianghaoyao@kfb.cn
 * @LastEditTime: 2025-12-11 14:33:17
 * @Description  : 
 */
...
#define HumanAreaDetect_DEBUG 0

namespace HumanAreaDetect_NS
{
    class CHumanAreaDetectV3_0
    {
    public:

        CHumanAreaDetectV3_0(InParam_S stInParam);
        ~CHumanAreaDetectV3_0();
         ...
         * @note
         */
        bool process(InData_S stInData, std::vector<Result_S>& vecResult, std::vector<Result_S>& vstModelDetectResult, OutData_S* stOutData = nullptr);
    ...
    private:
        ...
        int   m_nMaxTimeLost = 30;
         /* [float] m_fFallDownThresh: 人员摔倒阈值 */
        float m_fFallDownThresh = 0.5;
