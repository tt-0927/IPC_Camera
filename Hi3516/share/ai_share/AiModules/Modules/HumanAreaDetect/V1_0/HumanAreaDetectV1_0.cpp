/*
 * @FilePath     : HumanAreaDetectV1_0.cpp
 ...
 * @Description  : 人少场景
 */
#include "HumanAreaDetectV1_0.hpp"
...
HumanAreaDetect_NS::CHumanAreaDetectV1_0::CHumanAreaDetectV1_0(InParam_S stInParam)
    : m_stInParam(stInParam)
{
}

HumanAreaDetect_NS::CHumanAreaDetectV1_0::~CHumanAreaDetectV1_0()
{
    unInit();
}

/* 初始化 */
bool HumanAreaDetect_NS::CHumanAreaDetectV1_0::init()
{
...
/* 反初始化 */
bool HumanAreaDetect_NS::CHumanAreaDetectV1_0::unInit()
{
...
/* 处理数据 */
bool HumanAreaDetect_NS::CHumanAreaDetectV1_0::process(
    InData_S stInData,
...
/* 处理数据 */
bool HumanAreaDetect_NS::CHumanAreaDetectV1_0::resizeAndPadImage(cv::Mat inputImage, cv::Mat &outputImage)
{
...
bool HumanAreaDetect_NS::CHumanAreaDetectV1_0::resizeAndPadImage2(cv::Mat inputImage, cv::Mat &outputImage)
{
    int imageWidth = inputImage.cols;
    int imageHeight = inputImage.rows;
    m_fResizeScale = static_cast<float>(m_nLimitWidth) / std::max(imageWidth, imageHeight);
...
/* 拌线检测：判断两条线段是否有交点 */
TripLineType_E HumanAreaDetect_NS::CHumanAreaDetectV1_0::tripLineDetection(
...
bool HumanAreaDetect_NS::CHumanAreaDetectV1_0::isBoundingBoxIntersecting(
...
int HumanAreaDetect_NS::CHumanAreaDetectV1_0::crossProduct(
...
/* 入侵检测：判断禁止入侵的区域有无点 */
bool HumanAreaDetect_NS::CHumanAreaDetectV1_0::intrusionZoneDetection(
    const cv::Point &lastPoint,
...
bool HumanAreaDetect_NS::CHumanAreaDetectV1_0::entryZoneDetection(
    const cv::Point &startPoint,
    const cv::Point &lastPoint,
    std::vector<cv::Point> polygons)
{
...
bool HumanAreaDetect_NS::CHumanAreaDetectV1_0::leaveZoneDetection(
    const cv::Point &startPoint,
    const cv::Point &lastPoint,
    std::vector<cv::Point> polygons)
{
...
/* 判断两个多边形是否有交点 */
bool HumanAreaDetect_NS::CHumanAreaDetectV1_0::isIntersecting(
...
/* 判断目标框与线段是否有交点 */
bool HumanAreaDetect_NS::CHumanAreaDetectV1_0::isLineIntersectingRect(
