/*
 * @FilePath     : BridgeAlgorithmBase.hpp
 * @Author       : 严泽辉 yanzeh@kfb.cn
 * @Date         : 2024-03-08 10:36:45
 * @LastEditors  : 严泽辉 yanzeh@kfb.cn
 * @LastEditTime : 2024-03-14 16:09:51
...
#include "BridgeAlgorithmExtern.hpp"
#include "DataQueue.hpp"

namespace BDGA_NS
{
    class CBridgeAlgorithmBase
    {
    public:

        CBridgeAlgorithmBase(InParam_S stInParam);
        virtual ~CBridgeAlgorithmBase();
         ...
         * @note
         */
        BlError_E read_analysisResult(AnalyzerResult_S& stOutInfo, int nTimeOutMs = 0);
         ...
         * @note 阻塞调用
         */
        BlError_E realTime_dataAnalysis(MediaDataInfo_S stMediaDataInfo, AnalyzerResult_S& stOutInfo);
         ...
         * @note
         */
        virtual BlError_E setDatumLine(std::list<PosInfo_S> listPos);
    ...
    private:
        ...
        BQ_NS::CBlockingQueue<AnalyzerResult_S>* m_pResultQueue  = nullptr;
    };
