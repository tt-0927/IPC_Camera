/*
 * @FilePath     : CountingAlgorithmV2.hpp
 * @Author       : yanzeh yanzeh@kfb.cn
 * @Date         : 2024-01-08 15:13:45
 * @LastEditors  : yanzeh yanzeh@kfb.cn
 * @LastEditTime : 2024-01-23 14:40:34
...
namespace CA_NS
{
    class CCountingAlgorithmV2 : public CCountingAlgorithmBase
    {
    public:

        CCountingAlgorithmV2(CountingAnalyzerInParam_S stInParam);
        ~CCountingAlgorithmV2();
