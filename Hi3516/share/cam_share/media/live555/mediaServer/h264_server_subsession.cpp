 ...
 * @Date: 2023-07-17 16:09:50
 * @LastEditors: error: error: git config user.name & please set dead value or install git && error: git config user.email & please set dead value or install git & please set dead value or install git
 * @LastEditTime: 2023-07-17 16:10:30
 * @FilePath: \tv-620hu\code\osshare\live555\mediaServer\h264_server_subsession.cpp
 * @Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 */
#include "h264_server_subsession.h"


H264_Server_Subsession* H264_Server_Subsession::createNew(UsageEnvironment & env, Video_Source_Info_t& sourceInfo)
{
  return new H264_Server_Subsession(env, sourceInfo);
}

H264_Server_Subsession::H264_Server_Subsession(UsageEnvironment & env, Video_Source_Info_t& sourceInfo)
: OnDemandServerMediaSubsession(env, True)
{
	printf("H264_Server_Subsession is create\n");
...
H264_Server_Subsession::~H264_Server_Subsession() {
	printf("H264_Server_Subsession is delete\n");
...
static void afterPlayingDummy(void* clientData) {
  H264_Server_Subsession* subsess = (H264_Server_Subsession*)clientData;
  subsess->afterPlayingDummy1();
}

void H264_Server_Subsession::afterPlayingDummy1() {
...
void H264_Server_Subsession::checkForAuxSDPLine1() {
...
char const* H264_Server_Subsession::getAuxSDPLine(RTPSink* rtpSink, FramedSource* inputSource) {
...
FramedSource* H264_Server_Subsession::createNewStreamSource(unsigned /*clientSessionId*/, unsigned& estBitrate)
{
	estBitrate = 2000000;
...
RTPSink* H264_Server_Subsession
 ...
 */
void H264_Server_Subsession::startStream(unsigned clientSessionId,
                                         void *streamToken,
 ...
 */
void H264_Server_Subsession::deleteStream(unsigned clientSessionId, void *&streamToken)
{
  /**
