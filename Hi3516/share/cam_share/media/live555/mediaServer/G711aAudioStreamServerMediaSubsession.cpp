...
G711aAudioStreamServerMediaSubsession* G711aAudioStreamServerMediaSubsession ::createNew(UsageEnvironment& env,
                                                                                         Boolean reuseFirstSource,
                                                                                         Audio_Source_Info_t& stuG711)
{
    return new G711aAudioStreamServerMediaSubsession(env, reuseFirstSource, stuG711);
}

G711aAudioStreamServerMediaSubsession ::G711aAudioStreamServerMediaSubsession(UsageEnvironment& env,
                                                                              Boolean reuseFirstSource,
                                                                              Audio_Source_Info_t& stuG711)
...
G711aAudioStreamServerMediaSubsession ::~G711aAudioStreamServerMediaSubsession()
{
}

FramedSource* G711aAudioStreamServerMediaSubsession ::createNewStreamSource(unsigned /*clientSessionId*/,
                                                                            unsigned& estBitrate)
{
...
RTPSink* G711aAudioStreamServerMediaSubsession ::createNewRTPSink(Groupsock* rtpGroupsock,
