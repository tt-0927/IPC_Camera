...
FaceDetect_NS::CFaceDetectV2_0::CFaceDetectV2_0(InParam_S stInParam)
    : m_stInParam(stInParam)
{
}

FaceDetect_NS::CFaceDetectV2_0::~CFaceDetectV2_0()
{
    unInit();
}

/* 初始化 */
bool FaceDetect_NS::CFaceDetectV2_0::init()
{
    bool bRet = false;
...
/* 反初始化 */
bool FaceDetect_NS::CFaceDetectV2_0::unInit()
{
    if (m_pYolov5Point)
    {
...
/* 处理数据 */
bool FaceDetect_NS::CFaceDetectV2_0::process(
    InData_S stInData,
    ...
    OutData_S*             stOutData)
{
...

    {
        ...
        const float scaleY = static_cast<float>(m_nOrHeight) / m_nLimitHeight;
...
/* 处理数据 */
bool FaceDetect_NS::CFaceDetectV2_0::resizeAndPadImage(cv::Mat inputImage, cv::Mat &outputImage)
{
