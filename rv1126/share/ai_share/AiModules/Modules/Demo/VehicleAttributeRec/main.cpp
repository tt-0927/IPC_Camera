...
std::vector<std::vector<VehicleAttribute_NS::Result_S>> vAttributeOutData; /* 全局的结果 */
...
void AI()
{
    ...
    VehicleAttribute_NS::InParam_S stIn1Param;
    stIn1Param.strModelPath = "./RK3588_Vehicle_Attribute_V1.0.rknn";
    /* 初始化车牌识别检测 */
    VehicleAttribute_NS::CVehicleAttributeV1_0 *demo_attribute = new VehicleAttribute_NS::CVehicleAttributeV1_0(stIn1Param);
    ...
    VehicleAttribute_NS::InData_S stIn1Data;
    stInData.stParam.fBoxThreshold = 0.5;
    ...
    while (true)
    {
        ...
        std::vector<std::vector<VehicleAttribute_NS::Result_S>> vOutData1;
        ...
        {
            if (vOutData0[idx].nID != 1) continue;
            ...
            std::vector<VehicleAttribute_NS::Result_S> vOutData2;
        ...
        for (int i = 0; i < vDetectOutData.size(); i++)
        {
            ...
            if (idx < vAttributeOutData.size())
            {
                for (int j = 0; j < vAttributeOutData[idx].size(); j++)
                {
                    ...
                    text = vAttributeOutData[idx][j].strName;
