...
static void *videoFrameHandlThr(void *pParam)
{
    ...
    /* ---------------------- 模型初始化 ------------------------ */
    ClassroomMoveDetect_NS::InParam_S stInParam;
    stInParam.strModelPath = "./HeadDetect.rknn";
    /* 初始人脸检测检测 */
    ClassroomMoveDetect_NS::CClassroomMoveDetectV1_0 *demo = new ClassroomMoveDetect_NS::CClassroomMoveDetectV1_0(stInParam);
    ...
    ClassroomMoveDetect_NS::InData_S stInData;
    ...
    while (!g_bExit)
    {
        ...
        if (nstatus == 0 && naddr != 0)
        {
            ...
            ClassroomMoveDetect_NS::OutData_S vOutData;
            { /*---------------------------------- 模型推理 ------------------------------------ */
                /* ================================ 开始计时 ===================================== */
            ...
            { /* ---------------------------------- 显示函数 ----------------------------------  */
                ...
                std::string text2 = "Probability: " + std::to_string(vOutData.fDegreeMobility);
                cv::putText(aSrcImg, text2, cv::Point(50, 50), cv::FONT_HERSHEY_SIMPLEX, 1, cv::Scalar(0, 0, 255), 2);
