...
/* 结果容器 */
std::vector<HumanAreaDetect_NS::Result_S> vGlobalOutData; /* 全局的结果 */
/* ===================================================== AI需要的全局变量配置 ============================================================= */
...
void AI()
{
    ...
    /* 初始化车牌识别检测 */
    HumanAreaDetect_NS::CHumanAreaDetectV1_0 *demo = new HumanAreaDetect_NS::CHumanAreaDetectV1_0(stInParam);
    ...
    while (true)
    {
        ...
        std::vector<HumanAreaDetect_NS::Result_S> vOutData;
