...
#include "VehiclePlateDetectExt.hpp"
#include "LicensePlateRec.hpp"

namespace VehiclePlateDetect_NS
{
    class CVehiclePlateDetectV1_0
    {
    public:

        CVehiclePlateDetectV1_0(InParam_S stInParam);
        ~CVehiclePlateDetectV1_0();
