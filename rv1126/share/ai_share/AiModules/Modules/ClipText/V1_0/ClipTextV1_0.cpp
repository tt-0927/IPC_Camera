...
ClipText_NS::CClipTextV1_0::CClipTextV1_0(InParam_S stInParam)
    : m_stInParam(stInParam)
{
}

ClipText_NS::CClipTextV1_0::~CClipTextV1_0()
{
    unInit();
}

/* 初始化 */
bool ClipText_NS::CClipTextV1_0::init()
{
    bool bRet = false;
...
/* 反初始化 */
bool ClipText_NS::CClipTextV1_0::unInit()
{
    if (m_pClipText)
    {
        delete m_pClipText;
...
/* 处理数据 */
bool ClipText_NS::CClipTextV1_0::process(
    InData_S stInData,
