...
#include "ReflectiveDetectExt.hpp"
#include "YoloUltralytics.hpp"

#define ReflectiveDetect 0

namespace ReflectiveDetect_NS
{
    class CReflectiveDetectV1_0
    {
    public:

        CReflectiveDetectV1_0(InParam_S stInParam);
        ~CReflectiveDetectV1_0();
    ...
    private:
        ...
        int m_nReflectiveyFrameCount = 0;       // 反光衣检测帧数
    };
