/*
 * @FilePath     : HumanAreaDetectV2_0.hpp
...
{
    class CHumanAreaDetectV2_0
    {
    public:

        CHumanAreaDetectV2_0(InParam_S stInParam);
        ~CHumanAreaDetectV2_0();
    ...
    private:
        ...
        /**
         * @brief 拌线检测：判断两条线段与人形是否有交点
         * @param [Result_S] stResult 记录区域
         * @param [cv::Point] alertLineFirst: 警戒线第一个点坐标
         * @param [cv::Point] alertLineSecond: 警戒线第二个点坐标
         * @return [TripLineType_E] 类型
         * @note
         */                                
        TripLineType_E tripLineDetection(Result_S& stResult,
                                         const cv::Point &alertLineFirst,
                                         const cv::Point &alertLineSecond);
