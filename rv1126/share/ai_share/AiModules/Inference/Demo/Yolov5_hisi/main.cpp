...
int main(int argc, char **argv)
{
    ...
    CYolov5 *demo = new CYolov5(strConfigPath);
    /* 模型初始化 */
    demo->init();
    ...
    // stInputData.pData = (float*)resized_image.data;
    // stInputData.nDataSize = static_cast<int>(resized_image.total() * resized_image.elemSize())* sizeof(float);
