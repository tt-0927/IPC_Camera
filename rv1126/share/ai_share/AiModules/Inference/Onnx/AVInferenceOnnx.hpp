...
{
    class CAVInferenceOnnx
    {
    public:
        CAVInferenceOnnx(std::string strConfigPath);
        ...
        /**
         * @brief 获取模型的输入输出信息
         * @param [std::vector<std::vector<int64_t>>&] vInputAttrs: 输入形状
         * @param [std::vector<std::vector<int64_t>>&] vOutputAttrs: 输出形状
         * @return [*]
         * @note
         */
        bool getAttrs(std::vector<std::vector<int64_t>>& vInputAttrs, std::vector<std::vector<int64_t>>& vOutputAttrs);
         ...
         * @return [*]
         */
        bool getAllocatorWithDefaultOptions(Ort::AllocatorWithDefaultOptions& stAllocator);
