 ...
 * @Description  : 玩手机检测算法
 */
#include "PlayPhone.hpp"

#include <cstring>

#include "dlog.h"

InferenceV1_0_NS::CPlayPhone::CPlayPhone(std::string strModelPath)
...
InferenceV1_0_NS::CPlayPhone::~CPlayPhone()
{
    if (m_postProcess)
    {
        /* 后处理去初始化 */
...
/* 推理数据 */
bool InferenceV1_0_NS::CPlayPhone::inference(
