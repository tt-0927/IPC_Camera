...
InferenceV1_0_NS::CFallDetect::CFallDetect(std::string strModelPath)
...
InferenceV1_0_NS::CFallDetect::~CFallDetect()
{
    if (m_postProcess)
    {
        /* 后处理去初始化 */
...
/* 推理数据 */
bool InferenceV1_0_NS::CFallDetect::inference(
