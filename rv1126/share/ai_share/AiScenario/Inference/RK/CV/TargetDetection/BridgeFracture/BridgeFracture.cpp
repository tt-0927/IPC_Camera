/*
 * @FilePath     : BridgeFracture.cpp
 * @Author       : 吴才朋 wucp@kfb.cn
 * @Date         : 2024-08-01 16:29:52
 * @LastEditors  : 严泽辉 yanzeh@kfb.cn
 * @LastEditTime : 2024-08-02 16:44:32
 * @Description  : 桥梁断裂检测算法
 */
#include "BridgeFracture.hpp"

#include <cstring>

#include "dlog.h"

InferenceV1_0_NS::CBridgeFracture::CBridgeFracture(std::string strModelPath)
...
InferenceV1_0_NS::CBridgeFracture::~CBridgeFracture()
{
    if (m_postProcess)
    {
        /* 后处理去初始化 */
...
/* 推理数据 */
bool InferenceV1_0_NS::CBridgeFracture::inference(
