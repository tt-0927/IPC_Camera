...
int RK_FACES_DETECT::DetectFaceBgr(char* aInputImg, std::vector<int> &vBoxPoint)
{
	...
	/* 后处理 */
        ...
        {
        	cv::rectangle(aInputImg, cv::Point(vBoxPoint[i*14+0],vBoxPoint[i*14+1]), cv::Point(vBoxPoint[i*14+2],vBoxPoint[i*14+3]), cv::Scalar(255, 0, 0), 3);
		cv::circle(aInputImg, cv::Point(vBoxPoint[i*14+4],vBoxPoint[i*14+5]), 2, cv::Scalar(0, 255, 0), -1);
		cv::circle(aInputImg, cv::Point(vBoxPoint[i*14+6],vBoxPoint[i*14+7]), 2, cv::Scalar(0, 255, 0), -1);
		cv::circle(aInputImg, cv::Point(vBoxPoint[i*14+8],vBoxPoint[i*14+9]), 2, cv::Scalar(0, 255, 0), -1);
		cv::circle(aInputImg, cv::Point(vBoxPoint[i*14+10],vBoxPoint[i*14+11]), 2, cv::Scalar(0, 255, 0), -1);
		cv::circle(aInputImg, cv::Point(vBoxPoint[i*14+12],vBoxPoint[i*14+13]), 2, cv::Scalar(0, 255, 0), -1);
        }*/
        /* 释放输出 */
