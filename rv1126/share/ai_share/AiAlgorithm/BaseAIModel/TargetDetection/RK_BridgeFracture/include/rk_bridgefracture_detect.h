...
*  Modify date: 2024年3月13日
*/

#ifndef __RK_BRIDGE_DETECT_H__
#define __RK_BRIDGE_DETECT_H__
...
class CRkBridgeFracture
{
	...
	public:
		...
		/**
		  ...
		  * return 成功-> 0， 失败-> 1
		* */
		int DetectRkBridgeRgb(cv::Mat aInputImg,std::vector<float> &vPoints);
		...
		**/
	    CRkBridgeFracture();
	    CRkBridgeFracture(char* pModelPath);
