...
*  Author: hhj
*  description : 学生行为分析定义： "低头写字" , "低头看书", "抬头听课", "转头", "举手", "站立", "小组讨论", "教师指导"
*  Modify date: 2023年10月9日
*/

#ifndef __RK_STUDENT_BEHAVIOR_H__
#define __RK_STUDENT_BEHAVIOR_H__
...
class RK_STUDENT_BEHAVIOR_V1
{
	...
	public:
		/* yolo的阈值 */
	    	float fBoxThreshold=0.45;
	    	float fNmsThreshold=0.25;
	    	/* 类别 */
	    	std::vector<char*> classes = {"低头写字" , "低头看书", "抬头听课", "转头", "举手", "站立", "小组讨论", "教师指导"};
		...
		/**
		  ...
		  * return 成功-> 0， 失败-> 1
		* */
		int StudentBehaviorRgb(char* aInputImg,std::vector<float> &vPoints);
		...
		* */
		    RK_STUDENT_BEHAVIOR_V1();
		    RK_STUDENT_BEHAVIOR_V1(char* pModelPath);
...
#endif // __RK_RK_STUDENT_BEHAVIOR_H__
