...
#ifndef __RK_HEAD_SORT_H__
#define __RK_HEAD_SORT_H__
...
class RK_HEAD_SORT
{
	...
	public:
		...
		/**
		  ...
		  * return 成功-> 0， 失败-> 1
		* */
		int HeadSortDetectFaceRgb(cv::Mat aInputImg,std::vector<float> &vPoints);
