...
*  Author: wcp
*  description : 人头检测算法
*  Modify date: 2023年9月28日
*/

#ifndef __HEAD_FEATURE_H__
#define __HEAD_FEATURE_H__
...
class HEAD_DETECT
{
	...
	public:
		...
		/**
		  ...
		  * vPoints: 人头检测后的结果框（存储方式：[左上角坐标x，左上角坐标y，右下角坐标x，右下角坐标y，置信度，种类,...],的容器存储）
		  * return 成功-> 0， 失败-> 1
		* */
		int DetectFaceRgb(cv::Mat aInputImg,std::vector<float> &vPoints);
