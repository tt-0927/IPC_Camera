...
void cameraMove()
{
	while (true)
	{
		...
		if(vRtPoints.size()>0)
		{
			...
			float nXsleep = 500*abs(ntotal_cx-1920/2)/1920*(1+abs(ntotal_cx-1920/2)/1920);
			float nYspeed = 24;
			float nYsleep = 300*abs(ntotal_cy-1024/2)/1024;
