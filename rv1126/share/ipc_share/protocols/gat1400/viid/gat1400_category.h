...
// 图像类型 ImageType
constexpr char* IMAGE_TYPE_MOTOR_VEHICLE                = "01";     // 车辆大图
constexpr char* IMAGE_TYPE_LICENSE_PLATE_COLORFUL_SMALL = "02";     // 车牌彩色小图
constexpr char* IMAGE_TYPE_LICENSE_PLATE_BINARY         = "03";     // 车牌二值化图
constexpr char* IMAGE_TYPE_DRIVER_FACE                  = "04";     // 驾驶员面部特征图
constexpr char* IMAGE_TYPE_COPILOT_FACE                 = "05";     // 副驾驶面部特征图
constexpr char* IMAGE_TYPE_CAR_LOGO                     = "06";     // 车标
constexpr char* IMAGE_TYPE_VIOLATION_RULES              = "07";     // 违章合成图
constexpr char* IMAGE_TYPE_PASSING_VEHICLE              = "08";     // 过车合成图
constexpr char* IMAGE_TYPE_VEHICLE_CLOSEUP              = "09";     // 车辆特写图
constexpr char* IMAGE_TYPE_PERASON                      = "10";     // 人员图
constexpr char* IMAGE_TYPE_FACE                         = "11";     // 人脸图
constexpr char* IMAGE_TYPE_NONMOTOR_VEHICLE             = "12";     // 非机动车图
constexpr char* IMAGE_TYPE_THING                        = "13";     // 物品图
constexpr char* IMAGE_TYPE_SCENE                        = "14";     // 场景图
constexpr char* IMAGE_TYPE_OTHER                        = "100";    // 一般图片

// 视频图像信息基本对象的类型
constexpr char* BASIC_OBJECT_TYPE_VIDEO   = "01";     // 视频片段
constexpr char* BASIC_OBJECT_TYPE_IMAGE   = "02";     // 图片
constexpr char* BASIC_OBJECT_TYPE_FILE    = "03";     // 文件
constexpr char* BASIC_OBJECT_TYPE_OTHER   = "99";     // 其他

// 视频图像信息语义属性对象的类型
constexpr char* IMAGE_CNT_OBJECT_TYPE_PERSON             = "01";     //  人员
constexpr char* IMAGE_CNT_OBJECT_TYPE_MOTOR_VEHICLE      = "02";     //  机动车
constexpr char* IMAGE_CNT_OBJECT_TYPE_NONMOTOR_VEHICLE   = "03";     //  非机动车
constexpr char* IMAGE_CNT_OBJECT_TYPE_THING              = "04";     //  物品
constexpr char* IMAGE_CNT_OBJECT_TYPE_SCENE              = "05";     //  场景
constexpr char* IMAGE_CNT_OBJECT_TYPE_FACE               = "06";     //  人脸
constexpr char* IMAGE_CNT_OBJECT_TYPE_VIDEO              = "07";     //  视频图像标签
constexpr char* IMAGE_CNT_OBJECT_TYPE_OTHER              = "08";     //  其他

// 行为类型
constexpr char* BEHAVIOR_TYPE_TAILGATING                = "1";          // 尾随
constexpr char* BEHAVIOR_TYPE_LOITERING                 = "2";          // 徘徊
constexpr char* BEHAVIOR_TYPE_WITHDRAWING               = "3";          // 取款
constexpr char* BEHAVIOR_TYPE_FIGHT                     = "4";          // 打架
constexpr char* BEHAVIOR_TYPE_DRIVE                     = "5";          // 开车
constexpr char* BEHAVIOR_TYPE_CALL                      = "6";          // 打手机
constexpr char* BEHAVIOR_TYPE_OTHER                     = "99";         // 其他

// 年龄级别转年龄上下限
const std::vector<std::pair<int, int>> g_vAgeLabelList = {
    {0, 17},
    {15, 35},
    {36, 64},
    {65, 99}
