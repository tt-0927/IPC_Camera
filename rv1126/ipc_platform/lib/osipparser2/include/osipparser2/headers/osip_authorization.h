...
struct osip_authorization {
  ...
  char *keyversion; /**< 本地时间 zhouzr 添加 keyversion */
  char *random1;    /**< SIP服务器产生随机数 zhouzr 添加 random1 */
  char *random2;    /**< FDWSF产生随机数 zhouzr 添加 random2 */
  char *deviceid;   /**< SIP服务器设备ID zhouzr 添加 deviceid */
  char *serverid;   /**< SIP服务器设备ID zhouzr 添加 serverid */
  char *sign1;      /**< 用FDWSF私钥对 random2 + random1 + SIP服务器ID做数字签名后的结果 zhouzr 添加 sign1 */
};
