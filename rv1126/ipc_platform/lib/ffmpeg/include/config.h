...
#define FFMPEG_CONFIGURATION "--prefix=/home/zhouzr/workdir/camera/cam_project/cam_opensource_library/libffmpeg-4.3.2/ffmpeg-4.3.2/../build --extra-cflags=-Wno-attributes --cross-prefix=/opt/hisi-linux/x86-arm/arm-v01c02-linux-musleabi-gcc/bin/arm-v01c02-linux-musleabi- --enable-cross-compile --arch=arm --target-os=linux --pkg-config=pkg-config --pkg-config-flags=--static --enable-libx264 --extra-cflags=-I/home/zhouzr/workdir/camera/cam_project/cam_opensource_library/libffmpeg-4.3.2/ffmpeg-4.3.2/../../libx264/build/include/ --extra-ldflags=-L/home/zhouzr/workdir/camera/cam_project/cam_opensource_library/libffmpeg-4.3.2/ffmpeg-4.3.2/../../libx264/build/lib/ --enable-libx265 --extra-cflags=-I/home/zhouzr/workdir/camera/cam_project/cam_opensource_library/libffmpeg-4.3.2/ffmpeg-4.3.2/../../libx265/build/include/ --extra-ldflags=-L/home/zhouzr/workdir/camera/cam_project/cam_opensource_library/libffmpeg-4.3.2/ffmpeg-4.3.2/../../libx265/build/lib/ --enable-libfdk-aac --extra-cflags=-I/home/zhouzr/workdir/camera/cam_project/cam_opensource_library/libffmpeg-4.3.2/ffmpeg-4.3.2/../../libfdk-aac/build/include/ --extra-ldflags=-L/home/zhouzr/workdir/camera/cam_project/cam_opensource_library/libffmpeg-4.3.2/ffmpeg-4.3.2/../../libfdk-aac/build/lib/ --disable-everything --enable-static --disable-shared --enable-gpl --enable-nonfree --enable-muxer=mpegts --enable-protocol=file --enable-avformat --enable-avcodec --enable-avutil --enable-encoder=libx264 --enable-encoder=libx265 --enable-encoder=libfdk_aac --enable-parsers --enable-parser=h264 --enable-parser=hevc --enable-parser=aac --disable-doc --disable-debug --disable-iconv"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2021
#define FFMPEG_DATADIR "/home/zhouzr/workdir/camera/cam_project/cam_opensource_library/libffmpeg-4.3.2/ffmpeg-4.3.2/../build/share/ffmpeg"
#define AVCONV_DATADIR "/home/zhouzr/workdir/camera/cam_project/cam_opensource_library/libffmpeg-4.3.2/ffmpeg-4.3.2/../build/share/ffmpeg"
#define CC_IDENT "gcc 10.3.0 (musl-1.2.3 linux-5.10 V12CS61.005.010 2024-03-18 21:24:39)"
