 ...
 * @LastEditTime : 2025-12-11 11:18:46
...
std::vector<Video_NS::VideoConfig_S> &CStreamVideoConfig::getVideoConfigs()
{
...
void CStreamVideoConfig::fill_default_videoConfig()
{
    ...
    stVideoConfigMain.stVideoResolution.nWidth = PIXEL_WIDTH_4K;
    stVideoConfigMain.stVideoResolution.nHeight = PIXEL_HEIGHT_4K;
    ...
    stVideoConfigMain.nAverageBitrate = 8192;
    ...
    stVideoConfigMain.nIFrameInterval = 30;
    ...
    stVideoConfigSub.stVideoResolution.nWidth = PIXEL_WIDTH_1280;
    stVideoConfigSub.stVideoResolution.nHeight = PIXEL_HEIGHT_720;
    ...
    stVideoConfigSub.nBitrateUpperLimit = 2048;
    stVideoConfigSub.nAverageBitrate = 1024;
    ...
    stVideoConfigSub.nIFrameInterval = 30;
...
void CStreamVideoConfig::fill_default_videoRoiConfig()
{
    ...
    for (size_t i = 0; i < m_vstVideoConfig.size(); i++)
    {
...
void CStreamVideoConfig::fill_default_capabilitySet(Video_NS::VideoCapabilitySet_S &stCapabilitySet)
{
    ...
    const std::vector<std::pair<int, int>> mainResolutions = {
        {  PIXEL_WIDTH_4K,   PIXEL_HEIGHT_4K},
