...
class CSmokingDetect : public CAlgorithm
{
public:
...
private:
     ...
     */
    float sensitivityToConfidence(int sensitivity, float minConfidence = 0.3f, float maxConfidence = 0.6f);
...
private:
    /* 句柄 */
    SmokingDetect_NS::CSmokingDetectV1_0* m_pHandle = nullptr;
