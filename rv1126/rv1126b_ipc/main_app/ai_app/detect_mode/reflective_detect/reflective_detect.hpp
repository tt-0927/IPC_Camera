...
class CReflectiveDetect : public CAlgorithm
{
public:
...
private:
     ...
     */
    float sensitivityToConfidence(int sensitivity, float minConfidence = 0.2f, float maxConfidence = 0.5f);
...
private:
    /* 句柄 */
    ReflectiveDetect_NS::CReflectiveDetectV1_0* m_pHandle = nullptr;
