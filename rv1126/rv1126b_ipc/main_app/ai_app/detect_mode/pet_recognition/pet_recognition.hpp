 ...
 * @LastEditTime: 2025-11-24 20:11:45
 * @FilePath:/1126/rv1126b_ipc/main_app/ai_app/detect_mode/pet_recognition/pet_recognition.hpp
 * @Description: 宠物识别
 */
...
private:
    ...
    /**
     * @brief   : 宠物识别处理函数
     * @param    {std::vector<PetRecognition_NS::Result_S>} &stResults：算法输出结果
     */
    void processPetRecognition(std::vector<PetRecognition_NS::Result_S> &stResults);

private:

    /* 宠物识别句柄 */
    PetRecognition_NS::CPetRecognitionV1_0 *m_pPetDetHandle = nullptr;
    /* 队列 */
